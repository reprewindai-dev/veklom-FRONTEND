...
export const VNP_GRADE_BANDS: GradeBand[] = [
  ...
  { grade: "BB",  min: 75, color: "#00E5FF", bgColor: "rgba(255,184,0,0.1)",   borderColor: "rgba(255,184,0,0.25)" },
  { grade: "B",   min: 70, color: "#00E5FF", bgColor: "rgba(255,184,0,0.07)",  borderColor: "rgba(255,184,0,0.18)" },
