...
export default function PGLOnboardingPage() {
 ...
 const certRes = await api<{ certificate_id: string; profile_pgl_id: string }>("/api/v1/pgl/onboarding/agent-certificate",
 {
 body: {
 ...
 <div className="absolute top-0 left-0 w-full h-1 bg-theme-surface from-cos-accent to-transparent" />
 <div>
 ...
 <div className="bg-cos-surface2/55 border border-cos-border p-6 rounded-2xl relative overflow-hidden flex flex-col justify-between">
 <div className="absolute top-0 left-0 w-full h-1 bg-theme-surface to-transparent" />
 <div>
 <span className="text-[10px] font-semibold text-theme-accent uppercase tracking-widest font-mono block mb-1">
 Workspace Authority
 </span>
 ...
 <div className="absolute inset-0 bg-theme-surface from-cos-accent/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
 <div className="flex items-center gap-4">
...
function WorkspaceVisualizer({
 ...
 <div className="absolute top-0 left-0 w-full h-1 bg-theme-surface from-transparent via-brand-500/50 to-transparent" />
...
function WalletVisualizer({ wallet }: { wallet: any }) {
 ...
 <div className="aspect-[1.6] rounded-2xl bg-theme-surface from-bg-800 to-bg-900 border border-cos-border p-6 flex flex-col justify-between relative overflow-hidden">
