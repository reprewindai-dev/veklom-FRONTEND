...
export default function TrackerPage() {
 ...
 path:"/v1/runs",
 label:"Execution",
 detail:"a run record with the matching authorization and evidence identifiers",
 },
 {
 path:"/api/v1/platform/pulse",
 label:"Runtime",
 detail:"a pulse observation carrying the same runtime or deployment identifier",
 },
 ];
 const links = [
