  ...
  async function verifyPglProof() {
    ...
    try {
      ...
      storeSessionConsequence({
        ...
        pglProof: { ...lookup, checked_at: checkedAt },
        denials: current?.denials ?? [],
      });
    } catch (error) {
