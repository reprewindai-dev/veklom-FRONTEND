    ...
    <SectionShell stage={stage} proof={data.stageProof} records={data.records}>
      <div className="space-y-4">
        <Pillar title="Work" proof={data.stageProof}><PhaseTrace phases={[
          { id: "authorize", name: "Authorize", status: "pending", kind: "authority" },
          { id: "execute", name: "Execute", status: data.loading ? "current" : "pending", kind: "execution" },
          { id: "settle", name: "Settle", status: "pending", kind: "transport" },
        ]} /></Pillar>
