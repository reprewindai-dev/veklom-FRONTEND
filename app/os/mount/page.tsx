...
function endpoint(method: StageEndpoint["method"], path: string, baseUrl?: string): StageEndpoint {
  return { method, path, classification: "live", response: "CAPPO response", baseUrl };
}
