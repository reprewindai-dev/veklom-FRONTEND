...
export function LoginForm() {
  ...
  if (deviceFlowStarted && deviceData) {
    return (
      <div className="w-full max-w-md bg-theme-surface border border-theme-border rounded shadow-sm p-5 sm:p-8 text-center">
        <h2 className="text-xl font-sans font-bold text-theme-ink mb-4">Authorize a headless Veklom node</h2>
        <p className="text-theme-inkDim text-sm mb-4 break-words">
          1. Go to{" "}
          <a
        ...
        <div className="text-2xl sm:text-3xl font-mono font-bold text-theme-ink mb-6 tracking-widest break-all">
        ...
        <button
          onClick={() => setDeviceFlowStarted(false)}
          className="mt-6 text-xs text-theme-inkDim hover:text-theme-ink underline"
        >
          Cancel
        </button>
      </div>
    ...
    <div className="w-full max-w-md bg-theme-surface border border-theme-border rounded shadow-sm p-5 sm:p-8">
      ...
      <div className="flex flex-col gap-3">
        <Link
          ...
          className="w-full min-h-12 flex items-center justify-center gap-2 border border-theme-border bg-theme-bg hover:bg-theme-surface2 text-theme-ink font-bold py-2.5 px-3 rounded transition-colors"
        >
        ...
        <button
          ...
          type="button"
          disabled={loading}
          className="w-full min-h-11 flex items-center justify-center gap-2 border border-theme-border bg-theme-bg hover:bg-theme-surface2 text-theme-inkDim text-xs font-mono py-2 px-3 rounded transition-colors"
        >
