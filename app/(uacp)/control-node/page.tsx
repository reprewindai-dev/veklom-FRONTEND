...
export default function ControlNodePage() {
 ...
 <div className="absolute bottom-0 left-0 w-full h-[1px] bg-theme-surface from-[#00E5FF]/50 via-[#00E5FF]/10 to-transparent"></div>
 ...
 <div className={`pt-2 mt-4 bg-theme-surface ${nodeProtection ==="PROOF SOURCES VERIFIED" ?"from-[#00FF66]/10 border-[#00FF66] text-[#00FF66]" :"from-[#FFAB00]/10 border-[#FFAB00] text-[#FFAB00]"} to-transparent border-l-2 px-3 py-2 tracking-[0.2em] text-[10px] uppercase shadow-[inset_0_0_20px_rgba(0,255,102,0.05)]`}>
 {nodeProtection}
 </div>
 </div>
 </PanelCard>
 ...
 DOMAIN LAUNCHPADS
 <div className="h-[1px] flex-1 bg-theme-surface from-[#00E5FF]/20 to-transparent"></div>
 </div>
