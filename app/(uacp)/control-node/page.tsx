...
export default function ControlNodePage() {
  ...
  return (
    <div className="relative p-6 md:p-10 h-full overflow-y-auto bg-[#030303] selection:bg-[#00E5FF]/30 text-white scrollbar-thin scrollbar-thumb-[#00E5FF]/30 scrollbar-track-transparent">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col gap-3 mb-10 pb-8 relative">
          <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#00E5FF]/30 via-[#00E5FF]/10 to-transparent"></div>
          
          <div className="flex items-center gap-4">
            <StatusBadge state={verdictState} text={verdictTitle.toUpperCase()} />
            <div className="h-4 w-[1px] bg-[#00E5FF]/30"></div>
            <span className="text-[#00E5FF]/30 text-[11px] font-mono tracking-[0.2em] uppercase">Veklom Control Node</span>
          </div>
          
          <h1 className="text-white/95 text-3xl font-sans tracking-tight mt-2 font-bold">{verdictTitle}</h1>
          ...
          <div className="flex flex-wrap items-center gap-8 mt-6">
            <div className="flex flex-col gap-1.5">
              ...
              <span className="text-white/90 text-xs font-bold tracking-wide flex items-center gap-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <span className="text-white/90 text-xs font-bold tracking-wide">Zero-Trust Active</span>
            </div>
            <div className="flex flex-col gap-1.5">
              <span className="text-[9px] uppercase tracking-[0.2em] text-[#00E5FF]/40 font-mono">Last Sync</span>
              <span className="text-[#00E5FF]/80 text-xs font-mono tracking-wider bg-[#00E5FF]/10 px-2 py-0.5 rounded border border-[#00E5FF]/30">
        ...
        <div className="flex flex-col gap-8 pb-12">
            ...
            <div className="xl:col-span-2 flex flex-col gap-6">
              ...
              <PanelCard title="LIVE READINESS METRICS" className="min-h-[240px]">
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  ...
                  <button onClick={testRun} className="col-span-1 border border-[#00E5FF]/20 bg-void-metal/40 rounded-lg p-3 text-[10px] text-[#00E5FF]/70 hover:bg-[#00E5FF]/10 hover:text-white transition-all duration-300 font-mono tracking-widest uppercase flex flex-col items-center justify-center gap-2 group shadow-[0_0_15px_rgba(0,229,255,0.05)] hover:shadow-[0_0_20px_rgba(0,229,255,0.15)]">
                ...
                <PanelCard title="CONTROL POSTURE">
                  <div className="space-y-4 text-[11px] font-mono">
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                      ...
                      <span className="text-[#00FF66] font-bold tracking-wider drop-shadow-[0_0_8px_rgba(0,255,102,0.4)]">ENFORCING</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                    ...
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                      ...
                      <span className="text-[#00FF66] font-bold tracking-wider drop-shadow-[0_0_8px_rgba(0,255,102,0.4)]">ARMED</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                      <span className="text-white/40 uppercase tracking-widest">Circuit Breaker</span>
                      <span className="text-[#00FF66] font-bold tracking-wider drop-shadow-[0_0_8px_rgba(0,255,102,0.4)]">CLOSED</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                      <span className="text-white/40 uppercase tracking-widest">VNP Staking</span>
                      <span className="text-[#00FF66] font-bold tracking-wider drop-shadow-[0_0_8px_rgba(0,255,102,0.4)]">BONDED</span>
                    </div>
                ...
                <PanelCard title="PROOF & PAPER TRAIL">
                  <div className="space-y-4 text-[11px] font-mono">
                    ...
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                      ...
                      <span className="text-[#00FF66] font-bold tracking-wider">ACTIVE</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-[#00E5FF]/10 pb-3">
                    ...
                    <button className="w-full mt-4 bg-void-metal/30 border border-[#00E5FF]/20 text-[#00E5FF]/50 hover:bg-[#00E5FF]/10 hover:text-[#00E5FF] hover:border-[#00E5FF]/40 transition-all duration-300 rounded px-3 py-2 tracking-[0.1em] text-[10px] uppercase shadow-[0_0_15px_rgba(0,229,255,0.05)] text-center cursor-not-allowed">
              ...
              <PanelCard title="ATTENTION QUEUE">
                <div className="space-y-4">
                  ...
                  {!isWorkspaceReady && !workspace.isLoading && (
                    <div className="p-3 border border-rose-900/40 bg-rose-950/10 rounded-lg backdrop-blur-sm">
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-rose-300 font-bold font-sans text-sm tracking-wide">PGL Identity Sync Failed</span>
                  ...
                  <div className="p-3 border border-hazard-amber/30 bg-hazard-amber/5 rounded-lg backdrop-blur-sm">
                    <div className="flex justify-between items-start mb-2">
                      <span className="text-hazard-amber font-bold font-sans text-sm tracking-wide">Budget Nearing Cap</span>
                      <span className="text-[9px] bg-hazard-amber/20 text-hazard-amber border border-hazard-amber/30 px-1.5 py-0.5 rounded font-mono tracking-widest">WARNING</span>
                    </div>
                    <div className="text-[11px] text-white/50 mb-3 font-mono leading-relaxed">Workspace budget is at 85% of monthly allowance.</div>
                    <Link href="/budget">
                      <button className="text-[9px] px-3 py-1.5 border border-hazard-amber/30 bg-hazard-amber/10 hover:bg-hazard-amber/20 text-white rounded uppercase tracking-[0.2em] font-mono transition-all duration-300 hover:shadow-[0_0_10px_rgba(255,184,0,0.2)]">MANAGE BUDGET</button>
                    </Link>
                  </div>

                  <div className="p-4 border border-[#00E5FF]/10 bg-[#00E5FF]/5 rounded-lg flex items-center justify-center opacity-70">
          ...
          {/* 8. Domain Launchpads */}
          <div className="mt-6 pt-6 border-t border-[#00E5FF]/10 relative">
            <div className="text-[10px] tracking-[0.3em] text-white/40 font-sans mb-4 flex items-center gap-3">
              DOMAIN LAUNCHPADS
