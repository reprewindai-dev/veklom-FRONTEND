...
export default function RepoGatePage() {
 ...
 <li>Add <code className="bg-black px-1.5 py-0.5 rounded text-theme-accent">NEXT_PUBLIC_REPOGATE_URL</code> as an environment variable in the Control Plane Coolify settings, pointing to the live URL.</li>
