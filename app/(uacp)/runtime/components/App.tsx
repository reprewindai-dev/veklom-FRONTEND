...
export default function App() {
 ...
 setReplayLog(["⚡ BOOTING GNOMLEDGER REPLAY ENGINE","📡 Connection established. Retrieving verified block lineage...","🛡️ Root security anchor verified: SHA-256 enabled."
 ]);
 };
 ...
 setReplayRunning(false);
 setReplayLog(prev => [
 ...prev,"\n🛡️ REPLAY SEQUENCE COMPLETED SUCCESSFULLY.","🟢 Sovereign verification: 100% hash chain integrity validated.","👉 Copied/Downloaded Completed compliance proof. Reference Hash:" + (currentAgentEvents[currentAgentEvents.length - 1]?.event_hash ||"SECURE")
 ]);
 return;
 }
 ...
 return (
 <div className="bg-[#020617] text-slate-100 min-h-screen font-sans flex flex-col selection:bg-theme-accent selection:text-slate-900 border-t-2 border-theme-border">
 
 {/* Dynamic Cover Frame & Status */}
 <header className="px-6 py-4 bg-[#090d1f] border-b border-theme-border shadow-xl flex flex-col md:flex-row md:items-center md:justify-between gap-4">
 <div>
 <div className="flex items-center gap-3">
 <div className="p-2 bg-theme-surface to-magenta-600 rounded-lg text-slate-100 font-mono text-xl font-bold tracking-wider">
 VK
 </div>
 <div>
 <h1 className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
 Veklom <span className="font-mono text-xs font-medium px-2 py-0.5 bg-theme-surface2 border border-theme-border text-theme-accent rounded-full">Sovereign Authority Runtime</span>
 </h1>
 ...
 <div className="px-3 py-1.5 bg-[#0b132e] border border-theme-border rounded flex items-center gap-2">
 <span className="w-2 h-2 bg-emerald-500 rounded-full animate-ping"></span>
 <span className="text-slate-300">STATUS:</span>
 <span className="text-theme-accent font-medium">SECURE_ENCLAVE_ACTIVE</span>
 </div>
 ...
 <div className="px-3 py-1.5 bg-theme-surface from-emerald-950 border border-emerald-900 rounded flex items-center gap-3">
 ...
 <div className="p-4 bg-theme-surface from-[#070b1e] via-[#09102b] to-[#04081c] border border-theme-border rounded-xl shadow-lg">
 ...
 <span className="text-theme-accent font-semibold block mb-1">1. The Brain (LLM)</span>
 ...
 <div className="p-3 bg-theme-surface border border-theme-border rounded glow-cyan relative">
 ...
 <div className="bg-[#070c25] border border-theme-border rounded-xl shadow-xl overflow-hidden">
 <div className="px-5 py-4 bg-[#0a1133] border-b border-theme-border font-semibold text-slate-200 flex justify-between items-center">
 ...
 className="text-xs flex items-center gap-1.5 text-slate-400 hover:text-white transition px-2.5 py-1.5 bg-[#0e163d] rounded border border-theme-border cursor-pointer"
 id="reset-sim-btn"
 >
 ...
 <span className="px-1.5 py-0.5 bg-theme-surface2 text-theme-accent rounded text-[10px]">STAGE 1</span>
 ...
 className="text-left p-2 bg-[#0e153b]/60 hover:bg-[#121c4e] active:scale-95 border border-theme-border rounded transition text-xs flex flex-col justify-between cursor-pointer"
 >
 ...
 className="w-full h-24 p-3 bg-theme-surface border border-theme-border hover:border-theme-border focus:border-theme-border rounded text-sm text-slate-100 placeholder-slate-500 font-mono focus:outline-none transition leading-relaxed"
 />
 {rawIntent && (
 <button
 ...
 <div className="mt-4 p-5 bg-theme-surface border border-[#1e293b]/80 rounded-xl shadow-inner relative">
 <div className="mb-4">
 ...
 <span className="text-[10px] text-theme-accent bg-theme-surface2 px-2 py-0.5 border border-theme-border rounded font-bold uppercase animate-pulse">
 ...
 : isChecked 
 ?"bg-theme-surface2 border-theme-border text-theme-accent/70 hover:border-theme-border" 
 :"bg-theme-surface border-theme-border text-slate-500 hover:border-theme-border"
 }`}
 ...
 isRequiredButUnchecked ?"text-red-400" : isChecked ?"text-theme-accent/70" :"text-slate-500"
 }`}>
 {policy} Checkbox
 </span>
 ...
 className="w-4 h-4 rounded text-theme-accent bg-theme-surface border-theme-border focus:ring-0 focus:ring-offset-0 pointer-events-none"
 id={`checkbox-${policy}`}
 />
 </div>

 <div className="flex items-center justify-between text-[10px] font-mono mt-1 pt-1.5 border-t border-theme-border">
 ...
 isChecked 
 ?"text-theme-accent bg-theme-surface2" 
 : isRequiredButUnchecked 
 ?"text-red-400 bg-red-950/60 animate-pulse font-extrabold" 
 :"text-slate-600 bg-theme-surface"
 }`}>
 {isChecked 
 ?"🟢 AUTHORIZED" 
 : isRequiredButUnchecked 
 ...
 :"bg-[#0e163d] text-slate-500 border border-theme-border cursor-not-allowed"
 }`}
 id="compile-btn"
 >
 {compiling ? (
 ...
 exit={{ opacity: 0, y: -15 }}
 className="p-5 bg-theme-surface border border-theme-border rounded-xl flex flex-col gap-4"
 >
 <div>
 <div className="flex items-center justify-between mb-2">
 ...
 {/* Step breakdowns */}
 <div className="border border-theme-border rounded bg-theme-surface p-3 flex flex-col gap-3">
 ...
 <div key={sIdx} className="bg-theme-surface p-2.5 rounded border border-theme-border flex flex-col sm:flex-row justify-between sm:items-center gap-2 text-xs font-mono">
 <div>
 ...
 <span className="px-2 py-0.5 bg-[#0b1b36] border border-theme-border text-theme-accent rounded text-[10px]">
 ...
 <div className="mt-2 pt-2 border-t border-theme-border flex justify-between items-center text-xs font-mono">
 ...
 <div className="flex flex-col sm:flex-row gap-4 items-center justify-between border-t border-theme-border pt-4">
 ...
 disabled={evaluating}
 className="px-4 py-2 bg-theme-surface from-magenta-600 text-white font-mono font-bold text-xs rounded active:scale-95 transition cursor-pointer"
 ...
 <div className="mt-3 p-4 bg-[#0a0f28] border border-theme-border rounded-lg">
 ...
 disabled={mintingPGL}
 className="px-4 py-2 bg-theme-accent hover:bg-cyan-400 text-slate-950 font-bold font-mono text-xs rounded active:scale-95 transition cursor-pointer"
 id="mint-pgl-btn"
 >
 ...
 <div className="p-4 bg-theme-surface border border-theme-border rounded-xl font-mono text-xs">
 <div className="flex items-center gap-1.5 mb-2 text-theme-accent uppercase font-bold text-[10px] tracking-wider">
 <Fingerprint className="w-4 h-4" />
 PGL Pre-Execution Certificate
 </div>
 <div className="bg-theme-surface p-3 rounded flex flex-col gap-1.5 rounded-lg border border-theme-border text-[11px] leading-relaxed">
 <p className="text-slate-400">ID: <span className="text-theme-accent/70 font-bold">{activePGL.certificate_id}</span></p>
 <p className="text-slate-400">Genome: <span className="text-theme-accent truncate block text-[10px] bg-theme-surface p-1 border border-theme-border rounded mt-0.5">{activePGL.genome_hash}</span></p>
 <p className="text-slate-400">Constitution: <span className="text-theme-accent truncate block text-[10px] bg-theme-surface p-1 border border-theme-border rounded mt-0.5">{activePGL.constitution_hash}</span></p>
 <p className="text-slate-400">Plan Proof Hash: <span className="text-theme-accent truncate block text-[10px] bg-theme-surface p-1 border border-theme-border rounded mt-0.5">{activePGL.plan_hash}</span></p>
 <p className="text-slate-500 mt-1">Minted At (UTC): {activePGL.timestamp}</p>
 </div>

 {/* Select routing pathway prior to Minting EI */}
 {!activeEI && (
 <div className="mt-4 p-3 bg-theme-surface border border-theme-border rounded">
 ...
 className="bg-theme-surface border border-theme-border text-xs px-2.5 py-1.5 w-full rounded focus:outline-none focus:border-theme-border text-slate-200"
 >
 {routes.map(r => (
 ...
 disabled={mintingEI}
 className="px-4 py-2 bg-theme-surface to-magenta-600 text-white font-mono font-bold text-xs rounded active:scale-95 transition cursor-pointer"
 id="mint-ei-btn"
 >
 {mintingEI ? (
 <span className="flex items-center gap-1">
 ...
 isSelected 
 ?"bg-theme-surface2 border-theme-border glow-cyan font-bold" 
 :"bg-theme-surface border-theme-border text-slate-400"
 }`}
 >
 <div>
 <span className={isSelected ?"text-theme-accent/70" :"text-slate-400"}>{routeItem.model}</span>
 ...
 className="p-5 bg-theme-surface from-[#020617] via-[#091038] to-[#040822] border-2 border-magenta-900/60 rounded-xl glow-magenta"
 >
 ...
 <div className="p-2 bg-theme-surface border border-theme-border rounded leading-none flex items-center justify-between">
 ...
 activeEI.risk_tier ==="HIGH" ?"bg-red-950 text-red-400 border border-red-800" :"bg-theme-surface2 text-theme-accent border border-theme-border"
 ...
 <p className="p-1.5 bg-theme-surface border border-theme-border text-magenta-400 text-[10.5px] break-all rounded leading-relaxed">{activeEI.signature}</p>
 ...
 <span key={toolItem} className="px-2 py-0.5 bg-theme-surface2 border border-theme-border text-theme-accent rounded text-[10px]">
 {toolItem}
 </span>
 ))}
 </div>
 ...
 <div className="p-4 bg-theme-surface border border-theme-border rounded-lg flex flex-col md:flex-row gap-4">
 ...
 className="bg-theme-surface border border-theme-border text-xs px-2.5 py-1.5 w-full rounded focus:outline-none focus:border-theme-border font-mono"
 >
 ...
 className="bg-theme-surface border border-theme-border text-xs px-2.5 py-1.5 w-full rounded focus:outline-none focus:border-theme-border font-mono text-slate-200"
 />
 </div>
 ...
 <span className="font-bold text-slate-200 ml-1 block mt-0.5 p-1 bg-theme-surface rounded border border-theme-border">{executionResult.execution_attestation_hash}</span>
 </p>
 </div>
 ...
 <div className="bg-[#04081c] border border-theme-border rounded-xl shadow-xl flex-1 flex flex-col min-h-[600px] overflow-hidden">
 
 {/* Elegant Sliding Horizontal Tab Buttons */}
 <div className="flex border-b border-theme-border bg-[#070b22] shrink-0">
 <button 
 ...
 ?"border-theme-border text-theme-accent/70 bg-theme-surface2" 
 :"border-transparent text-slate-400 hover:text-slate-200 hover:bg-theme-surface"
 }`}
 id="live-ledger-tab"
 >
 ...
 <div className="px-4 py-3 bg-[#0a0f2b]/40 border-b border-theme-border flex justify-between items-center shrink-0">
 <span className="text-[10px] font-mono uppercase text-slate-300">Secure Synapse Block Storage</span>
 <span className="px-2 py-0.5 bg-theme-surface2 border border-theme-border text-theme-accent rounded text-[9px] font-mono">
 REALTIME CHAIN
 </span>
 </div>

 <div className="p-4 flex-1 overflow-y-auto font-mono text-[11px] leading-relaxed space-y-4">
 <div className="p-3 bg-theme-surface rounded border border-theme-border text-slate-400 leading-normal mb-2">
 ...
 <p className="mt-1 text-[11px] text-magenta-400 font-bold bg-theme-surface p-1.5 border border-theme-border rounded overflow-x-auto">
 Ct = SHA256( it + Jt + Et + a(exec) + H(ct) + H(Ct-1) )
 </p>
 </div>

 {/* Dynamic Ledger list rendering */}
 <div className="relative border-l border-theme-border pl-3 ml-2.5 space-y-6 list-none">
 {ledger.length === 0 ? (
 ...
 <span className="absolute -left-[17px] top-1 w-2.5 h-2.5 rounded-full bg-theme-accent ring-4 ring-[#04081c] z-10"></span>
 
 <div className="bg-[#070c25] border border-theme-border p-3 rounded-lg flex flex-col gap-1.5 transition hover:border-theme-border">
 <div className="flex justify-between items-center leading-none">
 <span className="text-theme-accent font-bold text-xs uppercase">Block #{block.index}</span>
 ...
 <span className="px-1.5 py-0.5 bg-theme-surface2 text-theme-accent/70 font-bold rounded text-[10px]">
 {block.action}
 </span>
 </p>
 ...
 <p className="text-slate-400 text-[10px] break-all truncate bg-theme-surface p-1 rounded font-normal block">{block.previous_hash}</p>
 
 <p className="text-slate-500 leading-none text-[10px]/none mt-1">CURRENT COMBINED Ct:</p>
 <p className="text-magenta-400 font-bold text-[10px] break-all truncate bg-theme-surface p-1 rounded font-normal block border border-magenta-950/40">{block.combined_hash}</p>
 </div>
 </div>
 </div>
 );
 ...
 <div className="p-4 bg-[#0a0f2b] border-t border-theme-border shrink-0 select-none">
 <button
 onClick={verifyCryptographyIntegrity}
 disabled={verifyingLedger || ledger.length === 0}
 className="w-full py-2 bg-[#0e163d] hover:bg-[#131e50] border border-theme-border text-slate-300 font-mono text-xs rounded transition uppercase font-bold flex items-center justify-center gap-1.5 active:scale-95 cursor-pointer"
 id="verify-crypt-btn"
 >
 {verifyingLedger ? (
 <>
 ...
 <>
 <Shield className="w-3.5 h-3.5 text-theme-accent" /> Verify Ledger Cryptography
 </>
 )}
 </button>
 ...
 {verificationOutput && (
 <div className="mt-2.5 p-3 bg-theme-surface border border-theme-border rounded font-mono text-[10px] leading-relaxed text-theme-accent whitespace-pre-wrap max-h-48 overflow-y-auto">
 {verificationOutput}
 </div>
 )}
 </div>
 ...
 <div className="p-3 bg-[#080d2d]/30 border border-theme-border rounded-lg">
 ...
 ?"bg-theme-surface2 border-theme-border text-white font-bold shadow-[0_0_8px_rgba(99,102,241,0.25)]" 
 :"bg-[#060a1f] border-theme-border text-slate-400 hover:text-slate-200 hover:border-theme-border"
 }`}
 >
 <span className="flex items-center gap-2">
 ...
 <span className="border-l border-dashed border-theme-border h-full ml-1"></span>
 </div>
 ...
 <div className="p-3 bg-theme-surface rounded-lg border border-[#1e293b]/70 font-mono text-[11px]">
 ...
 <div className="p-2 bg-theme-surface border border-theme-border rounded">
 <span className="text-slate-500 block text-[9px]">JURISDICTION:</span>
 <span className="text-theme-accent font-bold">{GNOMLEDGER_REPLAY_DATA.bundle.agents.find(a => a.agent_id === replaySelectedAgent)?.jurisdiction}</span>
 </div>
 <div className="p-2 bg-theme-surface border border-theme-border rounded">
 <span className="text-slate-500 block text-[9px]">GENOME VERSION:</span>
 <span className="text-theme-accent font-bold">Count: {GNOMLEDGER_REPLAY_DATA.bundle.agents.find(a => a.agent_id === replaySelectedAgent)?.version_count}</span>
 </div>
 <div className="p-2 bg-theme-surface border border-theme-border rounded col-span-2">
 ...
 <span key={rule} className="px-1.5 py-0.5 bg-theme-surface2 border border-theme-border text-theme-accent rounded text-[9px] uppercase">
 ⚙️ {rule}
 </span>
 ))}
 </div>
 ...
 <div className="bg-theme-surface p-3 rounded-lg border border-theme-border flex items-center justify-between gap-3 font-mono shrink-0 select-none">
 <div className="flex items-center gap-2">
 <button
 ...
 className="px-3.5 py-1.5 rounded text-[11px] font-bold bg-[#0e163d] border border-theme-border text-slate-400 hover:text-slate-200 hover:border-theme-border transition active:scale-95 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
 >
 Reset Player
 </button>
 </div>
 ...
 <div className="p-3 bg-theme-surface border border-[#1e293b] rounded-lg relative overflow-hidden flex flex-col h-56 font-mono text-[10.5px]/relaxed">
 <div className="flex justify-between items-center text-[9px]/none uppercase font-bold text-slate-550 border-b border-theme-border pb-2 mb-2 shrink-0">
 ...
 key={lIdx} 
 className={`${
 line.startsWith("\n") ?"mt-3 border-t border-theme-border pt-1 text-slate-100 font-bold" 
 ...
 : line.startsWith("📦") ?"text-theme-accent/70 max-w-full break-all"
 :"text-slate-400"
 }`}
 >
 {line}
 ...
 <footer className="py-4 text-center text-xs text-slate-500 border-t border-theme-border shrink-0 font-mono select-none">
