...
<span className="text-theme-accent">from</span> fastapi <span className="text-theme-accent">import</span> FastAPI
<span className="text-theme-accent">from</span> veklom_vnp.fastapi <span className="text-theme-accent">import</span> VNPx402Middleware
...
app.add_middleware(
 ...
 enforce_sla_stakes=<span className="text-theme-accent">True</span>,
 max_latency_p99_ms=<span className="text-theme-accent">150</span>
)

<span className="text-theme-accent">@app.get</span>(<span className="text-green-300">"/v1/resource"</span>)
<span className="text-theme-accent">async def</span> <span className="text-yellow-200">get_critical_data</span>():
 <span className="text-theme-accent">return</span> {"{"}<span className="text-green-300">"status"</span>: <span className="text-green-300">"success"</span>, <span className="text-green-300">"data"</span>: <span className="text-green-300">"..."</span>{"}"}
 </pre>
 </div>
 </section>
