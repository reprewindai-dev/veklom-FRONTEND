...
export default function x402Page() {
 ...
 <div className="text-theme-accent/70">X-VNP-Stake-Result: <span className="text-white">yield=0.005_USDC,slashed=false</span></div>
 <div className="text-theme-accent/70">X-Veklom-Receipt-ID: <span className="text-white">0x3a74772e925b54F7dAD7FD95c9Ba30825033f970</span></div>
 <div className="text-theme-accent/70">X-VNP-Evidence-Hash: <span className="text-white">zKSNARK_proof_alpha</span></div>
 </div>
 </section>
