...
export default function WhyVNPWinsPage() {
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-white selection:bg-[#00E5FF]/30 font-sans pb-32">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-16">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUpVariants} className="space-y-6 mb-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00E5FF]/10 border border-[#00E5FF]/20 text-[#00E5FF] text-xs font-mono font-bold uppercase tracking-widest">
          ...
          <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight leading-tight">
            VNP Measures <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-cyan-500">Reality.</span>
          </h1>
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="border-b border-white/10 text-xs font-mono tracking-widest uppercase">
                  ...
                  <th className="py-6 px-4 bg-[#00E5FF]/5 text-[#00E5FF] font-bold w-1/4 rounded-t-lg border-x border-t border-[#00E5FF]/20">VNP (Veklom)</th>
              ...
              <tbody className="text-sm border-b border-white/10">
                ...
                <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="py-5 px-4 bg-[#00E5FF]/5 font-bold text-white border-x border-[#00E5FF]/20">
                ...
                <tr className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="py-5 px-4 bg-[#00E5FF]/5 font-bold text-emerald-400 border-x border-[#00E5FF]/20 border-b rounded-b-lg">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUpVariants} className="grid md:grid-cols-2 gap-12 mb-24">
          <div className="space-y-6">
            ...
            <ul className="space-y-6 mt-4">
              <li className="flex gap-3 text-slate-300">
                <Check className="w-6 h-6 text-[#00E5FF] shrink-0 mt-1" />
                <div>
          ...
          <div className="bg-[#050505] border border-slate-900 rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute right-0 top-0 w-64 h-64 bg-[#00E5FF]/5 blur-3xl rounded-full" />
            ...
            <div className="space-y-4 font-mono text-sm">
              ...
              <div className="p-4 bg-[#00E5FF]/10 border border-[#00E5FF]/20 rounded">
