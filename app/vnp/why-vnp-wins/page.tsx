...
export default function WhyVNPWinsPage() {
 ...
 VNP Measures <span className="text-transparent bg-clip-text bg-theme-surface from-[#FFB800] to-amber-500">Reality.</span>
 </h1>
 ...
 <div className="bg-[#050505] border border-theme-border rounded-2xl p-8 relative overflow-hidden">
