...
export async function GET() {
 ...
 const x402Status =
 verificationStack.find((item) => item.section ==="x402 settlement evidence")?.status ||"Disconnected";
 ...
 headers: {"Access-Control-Allow-Origin":"*","Cache-Control":"no-store","X-VNP-Methodology":"VNP Methodology v1.0",
 },
 });
}
