...
const departments: AgentNode["department"][] = ["Engineering","Ops","Research","Revenue","Growth",
];

const roles: AgentNode["role"][] = ["Executor","Validator","Orchestrator","Arbiter","Router",
];

function authHeaders(req: NextRequest): HeadersInit {
 const headers: Record<string, string> = {
 Accept:"application/json","X-Veklom-Control-Plane":"swarm-map",
 };
