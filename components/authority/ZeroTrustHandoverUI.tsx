...
export default function ZeroTrustHandoverUI({ backendStatus, onApprove, onReject }: any) {
 ...
 className="w-full bg-theme-accent hover:bg-theme-accent text-white p-3 rounded-lg flex items-center justify-center gap-2 transition-colors font-semibold"
 >
