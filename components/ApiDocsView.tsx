...
export const ApiDocsView: React.FC = () => {
 ...
 -d '{"skillId":"skill-ecc-refactor-ts","harness":"ollama","humanRequester":"reprewindai@gmail.com","parameters": {"targetFilePath":"src/App.tsx","optimizationLevel":"O2"
 },"mode":"production"
 }'`,
...
payload = {"skillId":"skill-ecc-refactor-ts","harness":"ollama","humanRequester":"reprewindai@gmail.com","parameters": {"targetFilePath":"src/App.tsx","optimizationLevel":"O2"},"mode":"production"
}
...
func main() {
	payload := map[string]interface{}{"skillId":"skill-ecc-refactor-ts","harness":"ollama","humanRequester":"reprewindai@gmail.com","mode":"production",
	}
 ...
 <div>
 <div className="flex items-center gap-2 text-theme-accent text-xs font-medium mb-1">
 ...
 <div className="flex items-center gap-1 bg-theme-surface p-1 rounded-xl border border-theme-border text-2xs">
 ...
 {endpoints.map((ep) => (
 <div key={ep.id} className="bg-theme-surface p-6 rounded-2xl border border-theme-border space-y-4">
 <div className="flex items-start justify-between gap-4 border-b border-theme-border pb-3">
 <div>
 ...
 <div className="text-xs text-theme-accent mt-1">{ep.path}</div>
 </div>

 <button
 onClick={() => handleCopy(ep.path, ep.snippets[selectedLang])}
 className="px-3 py-1.5 rounded-lg bg-theme-surface border border-theme-border text-slate-300 hover:text-white text-3xs flex items-center gap-1.5 cursor-pointer"
 >
 ...
 <pre className="p-4 bg-theme-surface rounded-xl border border-theme-border text-2xs text-theme-accent/70 overflow-x-auto whitespace-pre">
