...
export default function MFASection({ apiBase, onAuthenticated }: MFASectionProps) {
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-theme-surface from-[#00f3ff] to-[#bc13fe] text-black font-black uppercase tracking-widest py-3 px-4 rounded-xl transition-all cursor-pointer font-mono text-xs shadow-[0_0_20px_rgba(0,243,255,0.4)] hover:brightness-110 active:scale-[0.98] disabled:opacity-50"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-2/3 bg-theme-surface from-[#bc13fe] to-pink-600 hover:brightness-110 text-white font-black uppercase tracking-widest py-3 px-4 rounded-xl shadow-[0_0_20px_rgba(188,19,254,0.3)] cursor-pointer transition-all disabled:opacity-50 font-mono text-xs"
 >
