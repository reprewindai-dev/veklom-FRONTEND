...
export default function SharingHub({ player }: SharingHubProps) {
 ...
 switch (t) {
 case 'calm_twilight':
 return 'bg-theme-surface via-black/40 to-pink-950/40 border-white/10';
 case 'cyberpunk_neon':
 return 'bg-theme-surface from-[#00f3ff]/20 via-black/40 to-[#bc13fe]/20 border-white/10';
 case 'cosmic_slate':
 default:
 return 'bg-theme-surface from-white/10 via-white/5 to-[#bc13fe]/10 border-white/10';
 }
 };
 ...
 disabled={sharing}
 className="w-full bg-theme-surface from-[#00f3ff] to-[#bc13fe] text-black font-black uppercase tracking-widest text-xs py-3 px-4 rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-all shadow-[0_0_15px_rgba(0,243,255,0.4)] hover:brightness-110 active:scale-[0.98] disabled:opacity-50"
 >
 {sharing ? (
 <>
