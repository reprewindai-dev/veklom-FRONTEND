...
export default function HolographicBoard({
 ...
 <span className="absolute inset-0 bg-theme-surface from-[#00f3ff]/10 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
 </>
 )}
 </button>
 );
