...
export default function CommunalResonanceEngine({
 ...
 if (coherence > 70) return 'text-theme-accent';
 return 'text-[#00f3ff]';
 };
 ...
 return (
 <div id="communal-resonance-panel" className="bg-theme-surface from-[#0c0f1d] via-black/90 to-black border border-[#bc13fe]/30 rounded-2xl p-6 backdrop-blur-xl relative overflow-hidden shadow-[0_0_40px_rgba(188,19,254,0.1)]">
 ...
 <span className={`text-[7px] px-1 rounded uppercase tracking-widest ${peer.isBot ? 'bg-theme-accent/10 text-theme-accent' : 'bg-theme-accent/10 text-theme-accent'}`}>
