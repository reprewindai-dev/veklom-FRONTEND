...
export default function PaymentConsole({
 ...
 className="w-2/3 bg-theme-surface from-[#00f3ff] to-[#bc13fe] text-black font-black text-[10px] font-mono tracking-widest py-2.5 px-4 rounded-xl flex items-center justify-center gap-1.5 shadow-[0_0_15px_rgba(0,243,255,0.4)] cursor-pointer hover:brightness-110 active:scale-[0.98] transition-all"
 >
