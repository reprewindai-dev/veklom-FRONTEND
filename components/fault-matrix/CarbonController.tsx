...
export default function CarbonController({ onAppendLedger, onStateUpdate }: CarbonControllerProps) {
 ...
 return (
 <div className="bg-[#0a0c14]/85 border border-theme-border p-4 rounded-xl flex flex-col justify-between h-full shadow-2xl" id="VeklomCarbonController">
 <div>
 
 {/* Core Header */}
 <div className="flex items-center gap-2.5 border-b border-theme-border pb-3 mb-4">
 <Leaf className="text-theme-accent w-5 h-5 animate-pulse" />
 ...
 <div className="p-3 bg-[#05070a]/40 border border-theme-border rounded-lg flex justify-between items-center">
 <div>
 ...
 <span className="text-[10px] uppercase font-mono text-theme-accent font-extrabold tracking-wider block">
 Grid Intensity Poll (Electricity Maps API)
 </span>
 {regions.map((reg) => (
 <div key={reg.name} className="bg-theme-surface p-2 rounded border border-theme-border flex justify-between items-center text-xs font-mono">
 ...
 reg.carbon < 50 ? 'text-theme-accent' : reg.carbon < 250 ? 'text-amber-400' : 'text-red-400'
 }`}>
 {reg.carbon} g/kWh
 </span>
 </div>
 ...
 <div className="w-full h-[140px] bg-[#05070a]/90 rounded-lg p-2 border border-theme-border">
 ...
 <div className="bg-theme-surface2 p-3 rounded-lg border border-theme-border">
 <span className="text-[10px] font-mono text-theme-accent font-bold block mb-2 uppercase tracking-wide">
 ...
 <div className="bg-[#05070a]/50 p-2.5 rounded border border-theme-border">
 ...
 <span className="text-cyan-455 flex items-center gap-1 font-semibold text-theme-accent">
