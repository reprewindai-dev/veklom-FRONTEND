        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-[#00E5FF] rounded flex items-center justify-center brand-glow">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li><Link href="/workspace" className="hover:text-[#00E5FF] transition-colors">Control Plane</Link></li>
              <li><Link href="/vnp" className="hover:text-[#00E5FF] transition-colors">VNP Benchmark</Link></li>
              <li><Link href="/agent-dual" className="hover:text-[#00E5FF] transition-colors">Agent Duel</Link></li>
              <li><Link href="/gpc" className="hover:text-[#00E5FF] transition-colors">Pipeline Builder</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><Link href="/blog" className="hover:text-[#00E5FF] transition-colors">Engineering Blog</Link></li>
              <li><a href="https://status.veklom.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#00E5FF] transition-colors">System Status</a></li>
              <li><a href="mailto:support@veklom.com" className="hover:text-[#00E5FF] transition-colors">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><Link href="/legal/sla" className="hover:text-[#00E5FF] transition-colors">Service Level Agreement</Link></li>
            </ul>
          </div>
        </div>
