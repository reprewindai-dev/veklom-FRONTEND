...
export function Pill({
 ...
 return (
 <span
 className={clsx("inline-flex items-center gap-1.5 rounded-md border px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider whitespace-nowrap",
 PILL_TONES[tone],
 className
 )}
 >
...
export function StatTile({
 ...
 {delta && (
 <span
 className={clsx("text-[10px] font-semibold tabular-nums shrink-0",
