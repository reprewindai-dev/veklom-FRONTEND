...
const CANONICAL = ["Identity & Security","Capability & Policy","Safety & Anomaly","Cost & Budget","Approval","Execution","Evidence & Proof","Audit & Compliance","Response",
];
...
export function Pipeline({
 ...
 {/* spine */}
 <div className="absolute left-[18px] top-2 bottom-2 w-px bg-theme-surface from-signal/40 via-white/10 to-transparent" />
 ...
 className={cx("flex w-full items-center gap-3 rounded-lg border bg-ink-800/40 px-3 py-2.5 text-left transition",
 reachedAndVisible ? style.ring :"border-white/8",
 expandable &&"hover:bg-ink-700/60",
 )}
 >
 <span
 className={cx("relative z-10 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border bg-ink-900 font-mono text-[11px]",
