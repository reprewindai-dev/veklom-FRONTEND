...
export const TerminalTrace: React.FC<TerminalTraceProps> = ({ 
 ...
 if (lower.includes('deploy') || lower.includes('k8s') || lower.includes('.yaml') || lower.includes('.yml')) return <Settings className="w-3.5 h-3.5 text-theme-accent" />;
 if (lower.includes('db/') || lower.includes('.sql') || lower.includes('schema')) return <Database className="w-3.5 h-3.5 text-theme-accent" />;
