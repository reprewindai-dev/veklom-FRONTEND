...
export function ForceFieldDashboard() {
  ...
  if (loading) {
    return (
      <div className="animate-pulse bg-slate-900 border border-slate-700 rounded-lg p-6">
  ...
  return (
    <div className="bg-slate-950 border border-cyan-500/30 rounded-xl overflow-hidden shadow-[0_0_15px_rgba(6,182,212,0.15)] relative">
      ...
      <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
        {Object.entries(posture.mitigations).map(([key, mitigation]) => (
          <div key={key} className="bg-slate-900 rounded-lg p-4 border border-white/5 flex flex-col justify-between">
            <div>
      ...
      <div className="bg-slate-900/50 p-3 text-center border-t border-white/5">
