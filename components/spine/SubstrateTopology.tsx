...
export const SubstrateTopology: React.FC<SubstrateTopologyProps> = ({
 ...
 return <Globe className="h-6 w-6 text-theme-accent" />;
 case 'rf_microcontroller':
 return <Radio className="h-6 w-6 text-theme-accent" />;
 }
 };
 ...
 : 'bg-theme-surface border-theme-border hover:border-theme-border hover:bg-theme-surface'
 }`}
 >
 {/* Status Indicator Pill */}
 <div className="flex items-start justify-between mb-3">
 <div className="p-2.5 rounded-lg bg-theme-surface border border-theme-border">
 ...
 <div className="mt-4 pt-3 border-t border-theme-border flex items-center justify-between text-xs font-mono text-slate-300">
 ...
 <div className="p-2 bg-theme-accent/10 border border-theme-border rounded-lg">
 {getNodeIcon(selectedNode.type)}
 </div>
 <div>
 <h3 className="font-bold text-white text-lg">{selectedNode.name}</h3>
 <span className="text-xs font-mono text-theme-accent">{selectedNode.region}</span>
 </div>
 </div>

 <div className="flex items-center space-x-1 bg-theme-surface p-1 rounded-lg border border-theme-border">
 <button
 ...
 <div className="p-3 rounded-lg bg-theme-surface border border-theme-border text-xs font-mono space-y-2">
 ...
 <span className={selectedNode.mcpEnabled ? 'text-theme-accent' : 'text-slate-500'}>
 ...
 <span className="text-theme-accent font-bold">{selectedNode.latencyMs} ms</span>
 </div>
 <input
 type="range"
 min="1"
 ...
 className="w-full accent-indigo-500 bg-theme-surface rounded-lg h-2 cursor-pointer"
 />
 </div>
 ...
 <div
 key={cap}
 className="px-3 py-2 bg-theme-surface border border-theme-border rounded-lg flex items-center justify-between text-xs font-mono"
 >
 <span className="text-slate-300">{cap}</span>
 <span className="px-1.5 py-0.5 rounded bg-theme-accent/10 text-theme-accent text-[10px]">
 GRANTED
 </span>
 </div>
 ))}
