  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 bg-slate-950 border border-slate-800 rounded-lg text-xs font-mono text-slate-200 focus:outline-none focus:border-emerald-500 w-full sm:w-56"
              />
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between text-[11px] text-slate-400">
                    ...
                    <span>Cap: <strong className="text-indigo-400">{rec.capabilityId}</strong></span>
                  </div>
        ...
        {selectedRecord && (
          <div className="lg:col-span-6 bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-5">
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="p-3 bg-slate-950 border border-slate-800 rounded-lg space-y-1">
                ...
                <span className="text-sky-300 break-all">{selectedRecord.pglSignature}</span>
              </div>
            ...
            <div className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-3">
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-slate-900 border border-slate-800 rounded p-2 text-[11px] font-mono text-slate-300 focus:outline-none focus:border-indigo-500"
              />
