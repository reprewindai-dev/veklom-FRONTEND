...
export const InvariantSimulator: React.FC<InvariantSimulatorProps> = ({
 ...
 <div className="bg-theme-surface border border-theme-border rounded-xl p-6 shadow-md">
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
 <div>
 <span className="px-2.5 py-0.5 rounded text-xs font-mono font-medium bg-theme-accent/20 text-theme-accent/70 border border-theme-border">
 ...
 className="px-5 py-2.5 rounded-lg bg-theme-accent hover:bg-theme-accent text-white font-semibold text-sm transition flex items-center space-x-2 cursor-pointer shadow-lg shadow-theme-accent/20 disabled:opacity-50"
 >
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pt-6 border-t border-theme-border">
 <div className="p-4 rounded-lg bg-theme-surface border border-rose-500/30 space-y-1">
 ...
 <div className="p-4 rounded-lg bg-theme-surface border border-theme-border space-y-1">
 <div className="flex items-center space-x-2 text-theme-accent font-bold text-sm">
 ...
 <div className="lg:col-span-5 bg-theme-surface border border-theme-border rounded-xl p-6 space-y-5">
 ...
 <label className="flex items-center justify-between p-3 rounded-lg bg-theme-surface border border-theme-border cursor-pointer hover:border-theme-border">
 <div>
 ...
 <label className="flex items-center justify-between p-3 rounded-lg bg-theme-surface border border-theme-border cursor-pointer hover:border-theme-border">
 <div>
 <span className="text-xs font-semibold text-theme-accent block font-mono">Simulate Primary Node 503</span>
 ...
 onClick={handleRunTest}
 disabled={isExecuting}
 className="w-full py-3 rounded-lg bg-theme-accent hover:bg-theme-accent text-white font-semibold text-sm transition flex items-center justify-center space-x-2 cursor-pointer disabled:opacity-50"
 >
 {isExecuting ? <RefreshCw className="h-4 w-4 animate-spin" /> : <Play className="h-4 w-4 fill-current" />}
 ...
 {routeResult ? (
 <div className="bg-theme-surface border border-theme-border rounded-xl p-6 space-y-5">
 {/* Outcome Header Pill */}
 ...
 <span className="px-3 py-1 bg-theme-accent/10 text-theme-accent border border-theme-border rounded-full text-xs font-mono font-semibold">
 REROUTED FALLBACK
 </span>
 )}
 </div>
 ...
 <div className="p-3 bg-theme-surface border border-theme-border rounded-lg text-xs font-mono space-y-1.5 text-slate-300">
 ...
 <span className="text-theme-accent truncate max-w-[240px]">
 ...
 : 'bg-theme-surface border-theme-border text-slate-300'
 }`}
 >
 ...
 <div className="bg-theme-surface border border-theme-border rounded-xl p-12 text-center space-y-3">
 <div className="h-12 w-12 rounded-full bg-theme-accent/10 text-theme-accent flex items-center justify-center mx-auto border border-theme-border">
