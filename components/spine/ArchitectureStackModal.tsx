...
export const ArchitectureStackModal: React.FC<ArchitectureStackModalProps> = ({
 ...
 color: 'border-theme-border text-theme-accent/70 bg-theme-surface2',
 ...
 color: 'border-theme-border text-slate-300 bg-theme-surface',
 description: 'Foundational medium providing isolation, locality enforcement, and hardware resilience.',
 },
 ];

 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-theme-surface backdrop-blur-sm animate-fade-in">
 <div className="bg-theme-surface border border-theme-border rounded-2xl max-w-4xl w-full p-6 space-y-6 shadow-2xl overflow-y-auto max-h-[90vh]">
 {/* Header */}
 <div className="flex items-center justify-between border-b border-theme-border pb-4">
 <div className="flex items-center space-x-3">
 <div className="p-2.5 bg-theme-accent/10 border border-theme-border rounded-xl">
 <Layers className="h-6 w-6 text-theme-accent" />
 </div>
 <div>
 <h2 className="text-xl font-bold text-white">The 8-Layer Unified Substrate Stack</h2>
 <p className="text-xs text-slate-400 font-mono">"HTTP gives you a universal grammar. Computless gives you universal governance."
 </p>
 </div>
 </div>
 ...
 <button
 onClick={onClose}
 className="p-2 bg-theme-surface hover:bg-theme-surface text-slate-400 hover:text-white rounded-lg transition cursor-pointer"
 >
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 {/* Footer info */}
 <div className="pt-4 border-t border-theme-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400 font-mono">
 ...
 <button
 onClick={onClose}
 className="px-5 py-2 bg-theme-accent hover:bg-theme-accent text-white rounded-lg font-semibold transition cursor-pointer"
 >
 Close Diagram
 </button>
 </div>
