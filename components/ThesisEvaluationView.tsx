...
export const ThesisEvaluationView: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8 text-slate-200">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl relative overflow-hidden">
        <div className="absolute -right-12 -bottom-12 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-8 pt-6 border-t border-slate-800/80">
          {[
            ...
            >
              <div className="text-2xs font-mono uppercase tracking-wider text-cyan-400 mb-0.5">0{s.id}</div>
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 space-y-4">
            ...
            <div className="bg-slate-950 p-5 rounded-xl border border-slate-800 space-y-4">
              <h4 className="text-xs font-bold text-cyan-400 uppercase tracking-wider font-mono">cAPI Interception & Payload Translation Sequence</h4>
              <div className="grid grid-cols-1 md:grid-cols-5 gap-2 text-center text-xs font-mono">
                <div className="p-3 bg-slate-900 rounded-lg border border-slate-800">
                  <div className="text-cyan-400 font-bold">1. Requester / Agent</div>
                ...
                <div className="p-3 bg-slate-900 rounded-lg border border-cyan-500/40">
                  <div className="text-indigo-400 font-bold">3. Target Harness</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono">
              ...
              <div className="p-4 bg-slate-950 rounded-xl border border-slate-800 space-y-2">
                <div className="text-cyan-400 font-bold">Gemini Server-Side SDK</div>
                <p className="text-slate-400 text-2xs leading-normal">
                  Uses `@google/genai` server-side SDK. API keys stored strictly in server process.env, never exposed to client browser.
                </p>
              </div>
              <div className="p-4 bg-slate-950 rounded-xl border border-slate-800 space-y-2">
                <div className="text-indigo-400 font-bold">Claude Code / Codex / Cursor</div>
                <p className="text-slate-400 text-2xs leading-normal">
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 space-y-4">
            ...
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3 font-mono text-xs">
              ...
              <div className="p-3 bg-slate-900 rounded-lg text-emerald-300 text-2xs overflow-x-auto border border-slate-800">
      ...
      {activeStep === 4 && (
        <div className="space-y-6">
          <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-sans text-xs">
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3">
                ...
                <div className="space-y-2 text-2xs text-slate-300">
                  <p>
                    <strong className="text-cyan-300 font-mono">Preferred Choice:</strong> Slice-based state management (Zustand / React Context with custom hooks).
                  </p>
              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3">
                <div className="flex items-center gap-2 text-emerald-400 font-bold font-mono text-xs border-b border-slate-800 pb-2">
            ...
            <div className="bg-slate-950 p-5 rounded-xl border border-indigo-500/30 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div>
                  <h4 className="font-bold text-sm text-white flex items-center gap-2">
                    <ShieldCheck className="w-4.5 h-4.5 text-indigo-400" /> 100% Transparent Veklom System Reality Matrix
                  </h4>
                ...
                <span className="px-2.5 py-1 rounded bg-indigo-500/10 border border-indigo-500/30 text-indigo-300 font-mono text-3xs font-bold">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left font-mono text-xs">
                  <thead>
                    <tr className="text-3xs text-slate-400 border-b border-slate-800">
                  ...
                  <tbody className="divide-y divide-slate-800/60 text-2xs">
                    ...
                    <tr className="hover:bg-slate-900/50">
                      <td className="py-2.5 text-cyan-300 font-bold">On-Chain Solana Settlement</td>
                      <td className="py-2.5"><span className="px-2 py-0.5 rounded bg-cyan-500/20 text-cyan-400 font-bold text-3xs">ASPIRATIONAL / FUTURE</span></td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono pt-2">
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-2">
                ...
                <ul className="text-slate-300 space-y-1.5 text-2xs">
                  <li><span className="text-cyan-400 font-bold">veklom-byos-backend:</span> Bring Your Own Storage / Services</li>
                  <li><span className="text-cyan-400 font-bold">cappo-backend:</span> Agent Execution Control Plane</li>
                  <li><span className="text-cyan-400 font-bold">gnomledger:</span> Proof-of-Graph Ledger (PGL)</li>
                  <li><span className="text-cyan-400 font-bold">lockerphycer:</span> Cryptographic Secrets Vault</li>
                  <li><span className="text-cyan-400 font-bold">uacpv3 (GPC):</span> General Policy Controller (RBAC)</li>
                  <li><span className="text-cyan-400 font-bold">cAPI:</span> Unified MCP & API Query Engine</li>
                  <li><span className="text-cyan-400 font-bold">veklom-vnp:</span> Veklom Nexus Protocol Telemetry</li>
                  <li><span className="text-cyan-400 font-bold">real-repo-gate-for-veklom:</span> Security Static Scanner</li>
                  <li><span className="text-cyan-400 font-bold">abide:</span> Hierarchical Abstract Plan Controller</li>
                </ul>
              </div>
