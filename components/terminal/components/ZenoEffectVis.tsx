...
export const ZenoEffectVis: React.FC<ZenoEffectVisProps> = ({ nCycles, isInterrogating }) => {
 ...
 <span className="text-[10px] font-mono text-theme-accent uppercase tracking-widest">N-Cycle Interrogation</span>
 ...
 <span className="text-[10px] font-mono text-theme-accent uppercase">Phase-Locked</span>
 </motion.div>
 )}
 </div>
 );
