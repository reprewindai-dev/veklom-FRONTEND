...
export default function QuantumTerminal() {
 ...
 <div className={`p-fill h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]`} style={{ width: `${p.v}%` }}></div>
 </div>
 ...
 <div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width: `${pct}%`}}></div>
 </div>
 <div className="flex justify-between items-center text-[10px]">
 ...
 <div className="h-1 bg-[#63b3ed1f] rounded-full overflow-hidden">
 <div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width:'37.5%'}}></div>
 </div>
 </div>
 ...
 <div className="flex-grow h-1.5 bg-[#63b3ed1f] rounded-full overflow-hidden"><div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width:'87%'}}></div></div>
 ...
 <div className="flex-grow h-1.5 bg-[#63b3ed1f] rounded-full overflow-hidden"><div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width:'74%'}}></div></div>
 ...
 <div className="flex-grow h-1.5 bg-[#63b3ed1f] rounded-full overflow-hidden"><div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width:'91%'}}></div></div>
 <span className="text-[#56d364] w-8 text-right">91%</span>
 </div>
 <div className="flex items-center gap-2 text-[10px]">
 <span className="text-[#3d5269] w-4">2</span>
 <span className="text-[#6b8299] min-w-[80px]">ZNE mitigation</span>
 <div className="flex-grow h-1.5 bg-[#63b3ed1f] rounded-full overflow-hidden"><div className="h-full bg-theme-surface from-[#63b3ed] to-[#bc8cff]" style={{width:'78%'}}></div></div>
 ...
 <button onClick={() => { if(typeof window !== 'undefined') window.location.href = `/swarm-map${window.location.search}`; }} className="text-[9px] text-[#bc8cff] hover:text-[#fff] bg-[#bc8cff1a] hover:bg-[#bc8cff33] px-2 py-0.5 rounded transition-colors uppercase cursor-pointer border border-[#bc8cff4d]">Open Full Swarm Map ↗</button>
 </div>
