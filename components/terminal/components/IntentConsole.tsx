...
export const IntentConsole: React.FC<IntentConsoleProps> = ({
 ...
 <span className="text-[7px] font-mono text-theme-accent/30 uppercase tracking-tighter">Multi-Agent Gateway Ready</span>
 </div>
 </div>

 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <Terminal size={18} className="text-theme-accent" />
 ...
 className="bg-black/60 border border-white/10 rounded-lg px-2 py-1 text-[10px] font-mono text-theme-accent focus:outline-none focus:border-theme-border"
 >
 {providers.map(p => (
 ...
 className="w-full h-32 bg-black/40 border border-white/10 rounded-xl p-4 text-sm font-mono text-white/90 placeholder:text-white/10 focus:outline-none focus:border-theme-border transition-all resize-none"
 onKeyDown={(e) => {
 ...
 <span className="text-[9px] font-mono text-theme-accent/50 font-bold uppercase tracking-widest">
