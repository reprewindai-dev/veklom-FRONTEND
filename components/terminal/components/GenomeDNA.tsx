...
export const GenomeDNA: React.FC<GenomeDNAProps> = ({ genome, mini }) => {
 ...
 <div className={`absolute top-0 left-0 w-full h-px bg-theme-surface ${layer.color} opacity-30`} />
 ...
 <div className="absolute top-0 right-0 w-64 h-64 bg-theme-surface from-[#00E5FF]/10 to-transparent rounded-full blur-[60px] -mr-32 -mt-32 pointer-events-none group-hover:scale-110 transition-transform duration-700" />
 <div className="absolute bottom-0 left-0 w-48 h-48 bg-theme-surface from-[#FFB800]/5 to-transparent rounded-full blur-[40px] -ml-24 -mb-24 pointer-events-none" />
 
 <div className="absolute inset-x-0 top-0 h-px bg-theme-surface from-transparent via-[#00E5FF]/50 to-transparent opacity-50" />
 ...
 {/* Ambient layer glow */}
 <div className={`absolute -bottom-10 -right-10 w-20 h-20 bg-theme-surface ${layer.color} opacity-10 blur-[20px] rounded-full group-hover/card:opacity-20 transition-opacity`} />
 ...
 className="flex-1 bg-theme-surface from-[#00E5FF]/60 to-[#00E5FF]/20 rounded-t-sm opacity-80"
 />
 ))}
 </div>
 </div>
