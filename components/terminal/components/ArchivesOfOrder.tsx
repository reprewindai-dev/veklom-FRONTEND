...
export const ArchivesOfOrder: React.FC<ArchivesOfOrderProps> = ({ isLocked, latency, coherence, progress }) => {
 ...
 <Archive size={18} className="text-theme-accent" />
 ...
 <span className="text-[10px] font-mono text-theme-accent font-bold">{latency.toFixed(1)}ms</span>
 </div>
 <div className="flex items-center gap-2 px-3 py-1 rounded bg-black/40 border border-white/5">
 ...
 <div className="flex items-center justify-between p-4 rounded-xl bg-theme-accent/5 border border-theme-border group hover:border-theme-border transition-all">
 ...
 <span className="text-theme-accent font-bold">{progress.toExponential(7)}%</span>
 </div>
 ...
 className="h-full bg-theme-accent shadow-[0_0_8px_rgba(192,132,252,0.5)]"
 />
 </div>
