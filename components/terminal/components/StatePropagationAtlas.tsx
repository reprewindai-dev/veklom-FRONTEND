...
export const StatePropagationAtlas: React.FC = () => {
 ...
 <Share2 size={18} className="text-theme-accent" />
 <h2 className="text-sm font-mono uppercase tracking-widest text-white/80">State-Based Recall Atlas</h2>
 </div>
 <span className="text-[9px] font-mono text-theme-accent/50 uppercase">Hybrid-Native</span>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
 {bindings.map((b, i) => (
 <div key={b.id} className="p-3 rounded-xl bg-black/40 border border-white/5 group hover:border-theme-border transition-all flex flex-col gap-2">
 ...
 <div className="flex items-center gap-2">
 <div className="p-1 rounded bg-theme-accent/10">
 ...
 className="w-8 h-[1px] bg-theme-accent/20"
 />
 </div>
 </div>
 ))}
 ...
 <div className="mt-4 p-4 rounded-xl bg-theme-accent/5 border border-theme-border flex flex-col gap-2">
 <div className="flex items-center gap-2">
 <Cpu size={14} className="text-theme-accent" />
 <span className="text-[10px] font-mono text-theme-accent uppercase font-bold">Hybrid Recurrent State (SSM)</span>
 </div>
