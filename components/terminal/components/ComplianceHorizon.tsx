...
export const ComplianceHorizon: React.FC = () => {
 ...
 reg.status === 'Active' ? 'text-theme-accent bg-cyan-400/10' : 'text-amber-400 bg-amber-400/10'
 }`}>
 {reg.status}
 </span>
 </div>
 ...
 initial={{ width: 0 }}
 animate={{ width: '85%' }}
 className="h-full bg-theme-surface to-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.3)]"
 />
 </div>
 </div>
 </div>
