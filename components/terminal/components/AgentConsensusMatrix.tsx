...
export const AgentConsensusMatrix: React.FC<AgentConsensusMatrixProps> = ({ activeNodes, consensusModel }) => {
 ...
 <p className="text-[10px] font-mono text-white/60 leading-relaxed uppercase">"My strategy is grounded in the great agent Gemini. The signals converge on a singular outcome."
 </p>
