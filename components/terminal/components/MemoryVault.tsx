  ...
  return (
    <div className="bg-white/5 rounded-2xl border border-white/10 p-6 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[9px] font-mono text-cyan-400/50 uppercase">Asset Convergence</span>
      </div>
      ...
      <div className="p-3 bg-cyan-400/5 border border-cyan-400/10 rounded-xl flex items-center gap-3">
