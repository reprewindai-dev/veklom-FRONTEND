...
const SCORECARD_AXIS_IDS: VNPDimensionId[] = ["security","availability","x402_compliance","documentation","throughput",
];
...
export default function NexusProtocol() {
 ...
 <div className="h-full bg-theme-surface via-[#00E5FF] to-[#00FF66] transition-all duration-300" style={{ width: `${state?.proof.probes.length ? (verifiedProbeCount / state.proof.probes.length) * 100 : 0}%` }} />
 </div>
