...
const AGENT_MODEL_MAP: Record<string, string> = {
 // Engineering agents use fast, precise coding models"agent-001":"anthropic/claude-sonnet-4-5","agent-002":"anthropic/claude-sonnet-4-5","agent-008":"anthropic/claude-opus-4-5", // Security needs deeper reasoning
 // Growth agents use fast models"agent-040":"google/gemini-2.5-flash","agent-041":"google/gemini-2.5-flash",
 // Commander uses the most powerful"agent-000":"anthropic/claude-opus-4-5",
 // Research gets multi-model via OpenRouter auto"agent-063":"openrouter/auto",
 // Default for all others"default":"anthropic/claude-sonnet-4-5"
};
...
function findMissionFile(agentId: string): string | null {
 const dirs = ["agents/phase0-scaffolding","agents/phase1-engineering","agents/phase2-vendor-acquisition","agents/phase3-user-acquisition","agents/phase4-retention-revenue","agents/phase5-daily-operations","agents/security-force","agents/rag-knowledge","agents/hrm-workforce"
 ];
