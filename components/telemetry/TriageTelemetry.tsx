...
export default function TriageTelemetry({ context }: TriageTelemetryProps) {
 ...
 const [ollamaUrlInput, setOllamaUrlInput] = useState("http://167.233.202.195:11434");
 ...
 setIsDeploying(true);
 setDeployProgress(0);
 setDeployLogs(["Initiating secure telemetry processing node on VPS...","Binding Zero-Trust authentication protocols...","Validating sovereign credentials..."
 ]);

 const logs = [
 `Connecting to registry.veklom.com/marketplace/${context}-telemetry:1.0.0...`,"Pulling isolated runtime image ... Success","Injecting telemetry scrubber filters...","Mounting GPU tensor layers ... Progress 30%","Mapping local interlink API endpoints to internal network...","Verifying cryptographic watermark configurations...","Telemetry processor node running securely in isolated sandbox container!"
 ];
 ...
 if (isLoadingAuth) {
 return (
 <div className="bg-[#0b0e14]/40 border border-theme-border rounded-xl p-8 flex flex-col items-center justify-center space-y-4 backdrop-blur-md">
 ...
 if (needsAuth || !user) {
 return (
 <div className="bg-[#0b0e14]/60 border border-theme-border rounded-2xl p-8 text-center backdrop-blur-md max-w-lg mx-auto shadow-2xl">
 ...
 <button 
 onClick={handleLogin} 
 className="w-full py-3 border border-theme-border rounded-lg bg-[#111622] hover:bg-[#161d2d] text-amber-500 hover:text-amber-400 font-mono text-xs uppercase tracking-wider font-bold transition flex items-center justify-center space-x-2 cursor-pointer shadow-lg"
 >
 ...
 return (
 <div className="bg-[#0b0e14]/60 border border-theme-border rounded-2xl overflow-hidden backdrop-blur-md shadow-2xl flex flex-col w-full text-slate-300">
 
 {/* Dynamic Header */}
 <div className="border-b border-theme-border p-5 bg-theme-surface from-amber-500/5 to-transparent flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
 <div>
 ...
 <div className="flex items-center space-x-1.5 bg-[#111622] border border-theme-border px-2.5 py-1 rounded">
 ...
 <div className="bg-theme-surface border-b border-theme-border px-5 py-2.5 flex items-center justify-between gap-4 flex-wrap text-[10px] font-mono">
 ...
 <>
 <div className="hidden sm:block h-3 w-px bg-theme-surface" />
 <div className="flex items-center space-x-1.5">
 ...
 <form onSubmit={handleBAASign} className="bg-[#111622]/50 border border-theme-border p-3.5 rounded-xl space-y-3">
 ...
 className="w-full text-xs px-2.5 py-1.5 border border-theme-border rounded bg-[#0b0e14] text-slate-200 focus:border-amber-500 focus:outline-none"
 required
 />
 </div>
 <div>
 ...
 {configuration?.baaSigned ? (
 <div className="bg-[#111622]/50 border border-theme-border p-3.5 rounded-xl space-y-3 font-mono text-[10px]">
 <div>
 ...
 className="w-full py-1.5 bg-[#161d2d] hover:bg-[#1a2538] border border-theme-border text-amber-500 hover:text-amber-400 font-bold text-xs uppercase tracking-wider rounded transition flex items-center justify-center gap-1.5 cursor-pointer"
 >
 ...
 {isDeploying ? (
 <div className="bg-[#0b0e14] border border-theme-border p-3 rounded-lg text-[9px] text-amber-400 space-y-2">
 ...
 <div className="h-20 overflow-y-auto space-y-1 text-slate-400 border-t border-theme-border pt-1.5 scrollbar-thin">
 ...
 className="w-full py-1 bg-theme-surface hover:bg-[#111622] border border-theme-border text-slate-400 hover:text-white font-bold text-[10px] uppercase tracking-wider rounded transition cursor-pointer"
 >
 ...
 <div className="bg-[#111622]/40 border border-theme-border rounded-xl p-4 space-y-3">
 ...
 className="text-left text-[10px] p-2 bg-[#0b0e14] hover:bg-[#111622] border border-theme-border rounded transition font-mono truncate text-amber-500/80 hover:text-amber-400 cursor-pointer"
 >
 {sample.title}
 </button>
 ))}
 ...
 rows={3}
 className="w-full text-xs p-2 border border-theme-border rounded bg-[#0b0e14] text-slate-200 focus:border-amber-500 focus:outline-none font-mono resize-none scrollbar-thin"
 />
 </div>
 ...
 className="w-full py-2 bg-theme-surface from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 disabled: disabled: disabled:text-slate-500 text-slate-950 font-bold text-xs uppercase tracking-wider rounded transition flex items-center justify-center gap-1.5 cursor-pointer"
 >
 ...
 exit={{ opacity: 0 }}
 className="bg-[#0b0e14] border border-theme-border rounded-lg p-3 space-y-2 text-[10px] font-mono"
 >
 <div className="grid grid-cols-2 gap-2 border-b border-theme-border pb-2">
 <div>
 ...
 <p className="text-[9px] text-slate-300 leading-snug bg-[#111622] p-2 rounded mt-1 border border-theme-border">{activeResult.redactedNotes}</p>
 </div>
 <div>
 ...
 <div className="bg-[#111622]/40 border border-theme-border rounded-xl p-4 flex-1 flex flex-col min-h-[180px] max-h-[250px]">
 ...
 <div key={audit.id} className="bg-[#0b0e14] border border-theme-border p-2 rounded flex flex-col space-y-1">
