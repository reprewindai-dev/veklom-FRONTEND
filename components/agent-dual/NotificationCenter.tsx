...
export function NotificationCenter({ notifications, onClear }: NotificationCenterProps) {
 return (
 <div id="alerts-console" className="bg-[#0d0f16] border border-white/10 rounded-lg p-4 h-full flex flex-col justify-between shadow-lg shadow-theme-accent/20">
 {/* Block Header */}
 <div className="flex items-center justify-between border-b border-white/5 pb-2.5 mb-3">
 <div className="flex items-center gap-2">
 <BellRing className="w-4 h-4 text-theme-accent" />
 ...
 <div className="p-1 rounded bg-theme-accent/10 border border-theme-border text-theme-accent">
 <Star className="w-3.5 h-3.5" />
 </div>
 )}
 </div>
