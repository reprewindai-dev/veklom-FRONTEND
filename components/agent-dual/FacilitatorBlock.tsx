...
export function FacilitatorBlock({ escrow }: FacilitatorBlockProps) {
 return (
 <div id="facilitator-security-card" className="bg-[#0d0f16] border border-white/10 rounded-lg p-5 relative shadow-lg shadow-theme-accent/20">
 <div className="absolute top-0 left-0 w-1/3 h-1 bg-theme-surface" />
 ...
 <span className="text-theme-accent flex items-center gap-0.5 select-all hover:text-theme-accent/70">
 ...
 disabled
 className="bg-theme-surface text-slate-500 text-xs font-bold uppercase tracking-wider px-4 py-2 rounded transition-colors duration-150 flex items-center gap-1 font-sans cursor-not-allowed"
 >
