...
export function LeaderboardBlock({ entries, userAddress }: LeaderboardBlockProps) {
 ...
 return (
 <div id="leaderboard-module" className="bg-[#0d0f16] border border-white/10 rounded-lg p-4 relative overflow-hidden shadow-lg shadow-theme-accent/20">
 ...
 className="bg-[#050608] border border-white/10 rounded pl-8 pr-3 py-1 text-xs font-mono text-white focus:outline-none focus:border-theme-border w-48 placeholder-slate-600"
 />
 ...
 isCurrentUser ? 'bg-theme-accent/5 font-bold border-l-2 border-theme-border' : ''
 }`}
 >
 {/* Position */}
