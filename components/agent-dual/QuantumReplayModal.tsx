...
export function QuantumReplayModal({ isOpen, onClose, replayData }: QuantumReplayModalProps) {
 ...
 {/* Modal Card wrapper */}
 <div className="relative w-full max-w-4xl bg-[#090a0f] border border-white/10 rounded-xl overflow-hidden shadow-2xl shadow-theme-accent/20 flex flex-col max-h-[90vh]">
 
 {/* Futuristic Grid Header */}
 <div className="bg-theme-surface border-b border-white/10 p-4.5 flex items-center justify-between">
 <div className="flex items-center gap-2.5">
 <div className="w-9 h-9 rounded bg-theme-accent/10 border border-theme-border flex items-center justify-center text-theme-accent">
 ...
 Block verification of deal timestamp {timestamp} â€¢ Stake: ${wager.toFixed(2)} USDC
 </p>
 </div>
 </div>
 <button 
 ...
 <span className="text-[8px] font-mono text-theme-accent uppercase tracking-widest font-bold">
 [ Step {currentStepIndex + 1} of {steps.length} ] â€” {currentStep.title}
 </span>
 <p className="text-xs text-slate-350 leading-relaxed font-sans font-medium">
 {currentStep.description}
 </p>
 </div>
 <div className="text-[10px] font-mono bg-theme-accent/10 text-theme-accent px-2 py-0.5 rounded border border-theme-border uppercase shrink-0">
 ...
 ? 'bg-theme-accent/10 border-theme-border shadow-md shadow-theme-accent/20'
 : 'bg-[#0b0c11]/80 border-white/5'
 }`}>
 <div className="flex items-center justify-between mb-3">
 <span className="text-[11px] font-bold text-theme-accent font-sans flex items-center gap-1">
 âš¡ AGENT A (Vector North)
 </span>
 {currentStep.state.playerPackets.length > 0 && (
 <span className="text-[10px] font-mono font-bold bg-theme-accent/20 text-theme-accent px-1.5 py-0.5 rounded border border-theme-border">
 ...
 <div className="bg-[#0b0d14] border border-theme-border rounded p-3 text-[11px] font-mono text-slate-400 mt-2">
 <div className="flex items-start gap-1.5">
 <BookOpen className="w-3.5 h-3.5 text-theme-accent shrink-0 mt-0.5" />
 <div className="space-y-1">
 <span className="text-[9px] uppercase font-bold text-theme-accent block tracking-wider">// Rule Compliance Engine Log</span>
 ...
 <span className="text-[10px] font-mono text-theme-accent shrink-0">
 ...
 className="py-1.5 px-4 bg-theme-accent hover:bg-theme-info active:scale-95 text-black rounded font-mono text-[10px] uppercase font-black tracking-wider transition-all cursor-pointer flex items-center gap-1.5"
 ...
 ðŸ’¡ <span className="text-slate-350">{bettingFeedback.edgeMsg}</span>
 </p>
 </div>
 </div>
 ...
 <span className="text-theme-accent font-bold">{ejectionFeedback.rating}</span>
 </div>
 <div className="flex items-center justify-between font-mono text-[10px]">
