...
export const SEKEDCompiler: React.FC<SEKEDCompilerProps> = ({ state }) => {
 ...
 { label: 'Resilience (R)', value: state.resilience, icon: <Shield size={10} />, color: 'text-theme-accent' },
 { label: 'Confidence (C)', value: state.confidence, icon: <Target size={10} />, color: 'text-theme-accent' },
 { label: 'Diversity (D)', value: state.diversity, icon: <Layers size={10} />, color: 'text-emerald-400' },
 { label: 'Stability (S)', value: state.stability, icon: <Anchor size={10} />, color: 'text-theme-accent' },
 ];
