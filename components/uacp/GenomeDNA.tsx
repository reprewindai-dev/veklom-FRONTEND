...
export const GenomeDNA: React.FC<GenomeDNAProps> = ({ genome }) => {
 ...
 <Fingerprint size={18} className="text-theme-accent" />
 <h2 className="text-sm font-mono uppercase tracking-widest text-white/80">Sovereign AI Genome</h2>
 </div>
 <div className="flex flex-col items-end">
 <span className="text-[9px] font-mono text-theme-accent/50 uppercase">Hash Identifier</span>
 <span className="text-xs font-mono font-bold text-theme-accent">0x{genome.hash}</span>
 </div>
 </div>
 ...
 <span className="text-theme-accent">Verified (SHA-256)</span>
 </div>
