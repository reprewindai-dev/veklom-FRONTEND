...
export const MitigationPathwaysPanel: React.FC = () => {
 ...
 <span className="text-[9px] font-mono text-white/20">C1: 1.5Â°C Compatible</span>
 </div>
 <p className="text-[11px] text-white/60 leading-relaxed font-mono italic">"{p.description}"
 </p>
