...
export const SignalIngestionFeed: React.FC<SignalIngestionFeedProps> = ({ signals }) => {
 ...
 <div className="px-2 py-0.5 bg-theme-accent/10 border border-theme-border rounded">
 <span className="text-[9px] font-mono text-theme-accent uppercase font-bold">Scanning SSRN Nodes</span>
 </div>
 </div>
 ...
 className="flex items-center justify-between p-3 rounded-xl bg-black/40 border border-white/5 group hover:border-theme-border transition-all"
 >
 ...
 <span className="text-[10px] font-mono font-bold text-theme-accent">{s.match_strength.toFixed(2)}%</span>
