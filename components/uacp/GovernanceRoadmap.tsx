...
export const GovernanceRoadmap: React.FC<GovernanceRoadmapProps> = ({ phases }) => {
 ...
 <div className="flex items-center gap-2">
 <span className="text-[9px] font-mono text-theme-accent/50 uppercase">Closing the Agent Security Gap</span>
 </div>
 </div>
 ...
 <div className="p-4 rounded-xl bg-black/40 border border-white/5 group-hover:border-theme-border transition-all flex flex-col gap-2">
 <div className="flex justify-between items-start">
 <div className="flex flex-col">
 <span className="text-[9px] font-mono text-theme-accent uppercase tracking-tighter">Phase 0{phase.id}</span>
 ...
 <div className="p-3 bg-theme-accent/5 border border-theme-border rounded-xl flex items-center gap-3">
 <Map size={14} className="text-theme-accent shrink-0" />
 <span className="text-[9px] font-mono text-theme-accent/70 uppercase leading-snug">
