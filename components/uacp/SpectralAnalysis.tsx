...
export const SpectralAnalysis: React.FC<SpectralAnalysisProps> = ({ data }) => {
 ...
 <div className="text-[8px] font-mono text-theme-accent/50">Carpet Level: Stable</div>
 </div>
 ...
 <span className="text-[7px] font-mono text-theme-accent/80">GAN-Latent-Recon</span>
 </div>
