...
export const ObservabilitySignals: React.FC<ObservabilitySignalsProps> = ({ signals }) => {
 ...
 <Radio size={18} className="text-theme-accent animate-pulse" />
 ...
 {signals.map((s) => (
 <div key={s.name} className="p-3 rounded-xl bg-black/40 border border-white/5 group hover:border-theme-border transition-all flex flex-col gap-2">
