...
export const DeterminismRatio: React.FC<DeterminismRatioProps> = ({ ratio, certainty, noise, entropy }) => {
 ...
 <div className="flex items-center gap-2 bg-cyan-400/10 px-2 py-0.5 rounded border border-theme-border">
 <span className="text-[10px] font-mono text-theme-accent font-bold uppercase tracking-tighter">TARGET: {ratio.toFixed(1)}</span>
 </div>
 </div>
 ...
 <span className="text-[8px] font-mono text-theme-accent/60 uppercase tracking-widest mt-1">Resource Optimizing</span>
 </div>
 </div>

 <div className="p-3 bg-cyan-400/5 border border-theme-border rounded-xl flex items-center justify-between">
 <div className="flex items-center gap-3">
 <Wallet size={14} className="text-theme-accent" />
 <span className="text-[10px] font-mono text-white/40 uppercase font-bold tracking-tight">Optimization Billing Mode</span>
 </div>
 <span className="text-[10px] font-mono text-theme-accent/60 uppercase font-bold">SOLO_SCALE: ✅</span>
 </div>
 </div>
 );
};
