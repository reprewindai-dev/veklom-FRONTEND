...
export const BoundedScaling: React.FC<BoundedScalingProps> = ({ metrics }) => {
 ...
 <span className="text-xs font-mono font-bold text-theme-accent">{(metrics.utilization * 100).toFixed(0)}% Load</span>
 </div>
 ...
 className="absolute inset-0 bg-theme-surface from-transparent to-transparent"
 />
 </div>
 </div>
 </div>
