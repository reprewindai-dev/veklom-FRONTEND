...
function CommandSearch() {
 ...
 className={clsx("flex w-full items-center gap-3 px-3 py-2 text-left transition",
...
export default function Shell({ children }: { children: React.ReactNode }) {
 ...
 <div className="w-16 h-16 rounded-full border-2 border-theme-border" />
 ...
 <Link
 href={m.href}
 className={clsx("group relative flex items-center gap-2.5 px-2.5 py-[7px] rounded-lg text-[13px] transition",
 active
 ...
 href={m.href}
 onClick={() => setMobileOpen(false)}
 className={clsx("group relative flex items-center gap-2.5 px-2.5 py-[10px] rounded-lg text-[13px] transition",
 active
 ?"bg-brand-500/[0.12] text-ink-50"
 :"text-ink-200 hover:bg-white/[0.04] hover:text-ink-50",
 locked &&"opacity-55"
