...
export default function PolicyManager({
 ...
 policy.type === 'owner' ? 'bg-theme-surface2 text-theme-accent border-theme-border' :
 ...
 <span className="font-mono font-bold text-theme-accent">{rule.id}</span>
 ...
 className="w-full bg-[#0B0C0E] border border-[#23272E] p-2 text-xs rounded text-gray-300 focus:outline-none focus:border-theme-border"
 >
 {agents.map(a => (
 ...
 className="rounded bg-[#0B0C0E] border-[#23272E] text-theme-inkDim focus:ring-0 focus:outline-none w-4 h-4 cursor-pointer"
 />
 ...
 ? (isShadowed ? 'bg-red-950/40 text-red-400 border border-red-900/60' : 'bg-theme-surface2 text-theme-accent border border-theme-border') 
 ...
 isConflict 
 ? (isShadowed ? 'bg-red-950/15 border-red-950/50 text-red-300' : 'bg-theme-surface2 border-theme-border text-theme-accent/70')
