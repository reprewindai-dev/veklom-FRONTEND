...
export default function PipelineVisualizer({
 ...
 {activeStepIndex > 0 ? (
 <span className="text-[10px] font-bold font-mono px-2 py-0.5 rounded border border-theme-border bg-theme-surface2 text-theme-accent">
 ...
 if (status === 'active') {
 stageBg = 'bg-theme-surface2 border-theme-border text-theme-accent shadow-[0_0_10px_rgba(59,130,246,0.15)]';
 titleColor = 'text-theme-accent/70';
 badgeComponent = <span className="text-[8px] bg-theme-surface2 text-theme-accent px-1 rounded font-bold font-mono uppercase animate-pulse">RUN</span>;
 ...
 status === 'active'
 ? 'bg-theme-accent text-slate-950 border-theme-border shadow-[0_0_8px_rgba(59,130,246,0.4)]'
 : status === 'success'
 ...
 <div className={`absolute bottom-full mb-2.5 hidden group-hover:block w-56 bg-[#0B0C0E] border border-theme-border text-gray-100 text-[10px] p-2.5 rounded shadow-[0_10px_25px_rgba(0,0,0,0.8)] z-50 pointer-events-none transition-all duration-200 leading-normal text-left font-sans ${
 stage.id <= 2
 ...
 <div className="font-bold text-theme-accent mb-1 flex items-center gap-1 font-mono text-[9px] uppercase tracking-wider border-b border-[#23272E] pb-1">
 <span className="w-1 h-1 rounded-full bg-theme-info animate-pulse" />
 ...
 ? 'bg-theme-surface2 border-theme-border'
 ...
 disabled={isRunning}
 rows={4}
 className="w-full bg-[#0B0C0E] font-mono text-xs p-3 border border-[#23272E] rounded text-theme-accent focus:outline-none focus:border-theme-border resize-y"
 />
 </div>
 ...
 if (log.includes('[SYSTEM]')) color = 'text-theme-accent font-bold';
 ...
 {isRunning && (
 <span className="text-xs text-theme-accent animate-pulse font-mono">
 ...
 statusColor = 'text-theme-accent bg-[#0B0C0E] border-theme-border animate-pulse';
 iconContent = <span className="w-1.5 h-1.5 bg-theme-info rounded-full" />;
 }
 ...
 isCurrent ? 'text-theme-accent' : isPast ? 'text-gray-200' : 'text-gray-500'
 }`}
 >
 {titles[i]}
 </div>
