...
export default function Dashboard({
 ...
 className="flex items-center gap-1 px-2.5 py-1 text-[10px] text-theme-accent hover:text-white bg-[#15181E] hover:bg-[#1A1D23] border border-[#23272E] transition-all rounded font-mono uppercase"
 >
 ...
 <div className="mt-2 flex items-baseline gap-2">
 <span className="text-3xl font-mono font-bold text-theme-accent">{avgTrustScore}</span>
 ...
 className="text-[10px] text-theme-accent hover:underline mt-1 block h-4 text-left font-mono"
 >
 Requires Quorum Signature â†’
 </button>
 </div>
 ...
 <span className="bg-theme-surface2 text-theme-accent border border-theme-border text-[9px] px-2 py-0.5 rounded font-mono">
 DAILY_LIMIT
 </span>
 </div>
 ...
 <div
 className="h-full bg-theme-surface to-green-400 transition-all duration-500"
 ...
 <span className="w-1.5 h-1.5 bg-theme-accent rounded-sm" />
 ...
 <circle cx="50" cy="110" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="120" cy="80" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="190" cy="120" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="260" cy="40" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="330" cy="90" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="400" cy="35" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 <circle cx="470" cy="42" r="3" fill="#0B0C0E" stroke="var(--theme-accent)" strokeWidth="1.5" />
 ...
 <span>â— <strong>Interactive baseline</strong> learns typical behavior patterns from historical nodes.</span>
 ...
 className="text-xs font-bold text-theme-accent hover:text-theme-accent/70 font-sans text-left hover:underline cursor-pointer transition-colors block"
 ...
 {isDrifting 
 ? `âš ï¸ High deviation logged. Agent has shifted execution intensity into unauthorized or peripheral pipelines.` 
 : driftInfo.actualTotal === 0
 ? `âœ“ Quiet operational window. No active ledger updates registered on live attestation channel.`
 : `âœ“ Healthy alignment index. Executing capabilities within safe baseline intervals.`
 }
 </div>
 ...
 actPct > 0 
 ? (isDrifting && (capId === 'db-delete' || capId === 'payout-trigger') ? 'text-red-400 font-bold' : 'text-theme-accent') 
 : 'text-gray-600'
 }`}>{actPctStr}%</span>
 </span>
 </div>
 ...
 slotColor = 'bg-theme-surface2 border-theme-border text-theme-accent/70';
 } else {
 ...
 <div className="flex items-center gap-1">
 <span className="w-3 h-3 bg-theme-surface2 border border-theme-border rounded" />
 <span className="text-theme-accent">3-4 Normal</span>
 </div>
 <div className="flex items-center gap-1">
 ...
 <Activity className="w-3 h-3 text-theme-accent" />
 ...
 Traffic Inspector: <span className="text-theme-accent/70 font-mono text-[11px]">{selectedHeatCell.rowLabel}</span>
 </h4>
 ...
 <div className="flex justify-between items-center text-[10px] text-theme-accent/80 font-mono">
 ...
 âš ï¸ PEAK TRAFFIC SPIKE DETECTED
 </span>
 )}
 </div>
 ...
 <span className="text-theme-accent font-bold">{ev.who.agentName}</span>
 ...
 className="bg-[#15181E] text-white border border-[#23272E] rounded px-2 py-0.5 text-[10px] uppercase font-bold text-ellipsis max-w-[130px] sm:max-w-xs focus:ring-1 focus:ring-theme-accent focus:outline-none"
 ...
 <Gauge className="w-3.5 h-3.5 text-theme-accent" />
 ...
 <span className="text-[8px] uppercase tracking-widest text-theme-accent font-mono font-black">PEER A</span>
 </div>
 </div>
 ...
 <span className={trustDiff > 0 ? 'text-theme-accent font-bold' : 'text-pink-400 font-bold'}>
 ...
 <div className="bg-[#15181E] p-1 border border-theme-border rounded flex items-center justify-between">
 <span className="text-gray-500">A used:</span>
 <span className="text-theme-accent font-bold">{budgetA_Used} / {budgetA_Limit}cr ({budgetA_Pct}%)</span>
 </div>
 ...
 <span className="text-theme-accent">A: {(agentA.successRate * 100).toFixed(0)}%</span>
 ...
 <div 
 className="h-full bg-cyan-550 transition-all duration-700 bg-theme-accent" 
 ...
 <div className="flex gap-1.5 font-bold">
 <span className="text-theme-accent">A: {driftInfoA.driftIndex}%</span>
 <span className="text-gray-600">|</span>
 ...
 <span className="text-[8.5px] text-theme-accent font-mono font-bold bg-theme-surface2 px-1.5 py-0.2 border border-theme-border rounded">
 ...
 <th className="p-2 text-theme-accent">PEER A: {agentA.name}</th>
 ...
 <td className="p-2 font-mono text-[9px] text-[#22d3ee]/80 selection:bg-theme-surface2">{agentA.publicKey}</td>
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-theme-accent hover:bg-theme-accent text-white text-[11px] font-bold font-mono transition-all shadow-sm cursor-pointer"
 ...
 <button
 onClick={() => setSelectedAgentIdForProfile(agent.id)}
 className="font-bold text-theme-accent hover:text-theme-accent/70 block text-[11px] font-sans text-left hover:underline cursor-pointer transition-colors"
 title="Click to view Agent Operational Profile"
 >
 {agent.name}
 </button>
 ...
 <div className="flex items-center gap-2">
 <div className="w-5 h-5 rounded bg-theme-accent/10 border border-theme-border flex items-center justify-center">
 <UserPlus className="w-3 h-3 text-theme-accent" />
 </div>
 ...
 className="w-full bg-[#15181E] border border-[#23272E] rounded p-2.5 text-white placeholder-gray-600 focus:outline-none focus:border-theme-border transition-colors"
 />
 </div>
 ...
 className="w-full bg-[#15181E] border border-[#23272E] rounded p-2.5 text-white focus:outline-none focus:border-theme-border transition-colors"
 >
 ...
 type="submit"
 disabled={isGeneratingProfile}
 className="px-4 py-2 rounded bg-theme-accent hover:bg-theme-accent text-white font-mono uppercase text-[10px] tracking-wider font-bold transition-all flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
 >
 {isGeneratingProfile ? (
 <>
 ...
 {/* ðŸ‘¤ VIEW AGENT OPERATIONAL PROFILE MODAL */}
 {selectedAgent && (
 <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-4">
 ...
 <div className="flex items-center gap-2">
 <div className="w-5 h-5 rounded bg-theme-accent/10 border border-theme-border flex items-center justify-center">
 <Fingerprint className="w-3 h-3 text-theme-accent" />
 </div>
 <div>
 ...
 selectedAgent.category === 'service' ? 'bg-theme-info' : 'bg-green-400'
 }`} />
