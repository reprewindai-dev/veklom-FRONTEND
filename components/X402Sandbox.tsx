...
export default function X402Sandbox({ onTransactionSettled }: X402SandboxProps) {
 ...
 // Console logs
 const [terminalLogs, setTerminalLogs] = useState<string[]>(["[SYSTEM] x402 CAPPO Payment Sandbox initialized.","[SYSTEM] Payer Wallet set to 0x3C44CdD...93BC with $10.0000 USDC balance.","[SYSTEM] Ready for machine-to-machine micro-clearance simulation."
 ]);
 ...
 {/* Wallet Section */}
 <div className="bg-[#090e1a] border border-theme-border rounded-2xl p-6 shadow-xl">
 ...
 <div className="bg-[#040711] p-3 rounded-xl border border-theme-border font-mono text-theme-accent select-all truncate">
 {walletAddress}
 </div>
 </div>
 ...
 <div className="bg-[#040711] p-3 rounded-xl border border-theme-border font-mono text-[#a4b8e6] truncate">
 {privateKey}
 </div>
 </div>

 <div className="grid grid-cols-2 gap-4">
 <div className="bg-theme-surface2 p-3.5 rounded-xl border border-theme-border">
 ...
 <span className="text-xs font-mono text-theme-accent block font-bold mt-1.5 flex items-center gap-1">
 ...
 className="w-full bg-theme-surface hover:bg-theme-surface border border-theme-border hover:border-theme-border text-white font-bold py-2.5 px-4 rounded-xl text-xs transition-colors cursor-pointer flex items-center justify-center gap-2"
 >
 ...
 <div className="bg-[#090e1a] border border-theme-border rounded-2xl p-6 shadow-xl space-y-4">
 <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2 border-b border-theme-border pb-3">
 ...
 selectedScheme === 'upto' ? 'bg-theme-surface2 border-theme-border text-white shadow shadow-theme-accent/20' : 'bg-theme-surface border-theme-border text-[#718ab6]'
 }`}
 >
 Metered Scheme (upto)
 ...
 className={`flex-1 py-2.5 rounded-xl font-bold border transition-all text-xs cursor-pointer ${
 selectedScheme === 'exact' ? 'bg-theme-surface2 border-theme-border text-white shadow shadow-theme-accent/20' : 'bg-theme-surface border-theme-border text-[#718ab6]'
 }`}
 >
 Flat Scheme (exact)
 ...
 className={`py-2 rounded-lg border text-[10px] font-medium transition-all cursor-pointer ${workloadType === 'summary' ? 'bg-theme-surface2 border-theme-border text-white' : 'bg-theme-surface border-theme-border text-[#718ab6]'}`}
 >
 Outcomes Sum
 </button>
 <button
 onClick={() => setWorkloadType('research')}
 className={`py-2 rounded-lg border text-[10px] font-medium transition-all cursor-pointer ${workloadType === 'research' ? 'bg-theme-surface2 border-theme-border text-white' : 'bg-theme-surface border-theme-border text-[#718ab6]'}`}
 >
 Outsourcing Research
 </button>
 <button
 onClick={() => setWorkloadType('sonar')}
 className={`py-2 rounded-lg border text-[10px] font-medium transition-all cursor-pointer ${workloadType === 'sonar' ? 'bg-theme-surface2 border-theme-border text-white' : 'bg-theme-surface border-theme-border text-[#718ab6]'}`}
 >
 Sonar Cyber Sentry
 </button>
 </div>
 ...
 rows={3}
 className="w-full bg-theme-surface border border-theme-border rounded-xl px-3 py-2 text-xs text-white"
 />
 </motion.div>
 ) : (
 <motion.div
 initial={{ opacity: 0 }}
 animate={{ opacity: 1 }}
 className="bg-[#040711] p-3 rounded-xl border border-theme-border"
 >
 ...
 className="flex-1 bg-theme-surface hover: hover: disabled: disabled: disabled:text-[#526a9b] text-white font-bold py-3 px-4 rounded-xl text-xs transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer"
 >
 ...
 disabled={isLooping || currentStage === 0}
 className="p-3 bg-theme-surface border border-theme-border hover:border-theme-border rounded-xl text-[#718ab6] hover:text-white transition-all text-xs cursor-pointer"
 title="Clear states"
 >
 Reset State
 </button>
 ...
 {/* Step-by-step UI */}
 <div className="relative border-l border-theme-border ml-3 space-y-4">
 
 {/* Stage 1 */}
 <div className="relative pl-6">
 <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border-2 ${currentStage === 1 ? 'bg-cyan-400 border-theme-border animate-pulse' : currentStage > 1 ? 'bg-[#14bd96] border-[#14bd96]' : 'bg-theme-surface border-theme-border'}`} />
 <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
 <div>
 <h4 className={`text-xs font-bold ${currentStage === 1 ? 'text-theme-accent' : 'text-white'}`}>Stage 1: Challenge (HTTP 402 Required)</h4>
 ...
 className="px-2.5 py-1 bg-theme-surface border border-theme-border hover:border-theme-border hover:bg-theme-surface rounded text-[10px] font-bold text-theme-accent cursor-pointer"
 >
 Trigger 1
 </button>
 )}
 ...
 {challengeData && (
 <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="bg-[#040711] p-3 rounded-xl border border-theme-border mt-2 font-mono text-[10px] text-theme-accent/70">
 ...
 {/* Stage 2 */}
 <div className="relative pl-6">
 <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border-2 ${currentStage === 2 ? 'bg-cyan-400 border-theme-border animate-pulse' : currentStage > 2 ? 'bg-[#14bd96] border-[#14bd96]' : 'bg-theme-surface border-theme-border'}`} />
 <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
 <div>
 <h4 className={`text-xs font-bold ${currentStage === 2 ? 'text-theme-accent' : 'text-white'}`}>Stage 2: Authorization Signing</h4>
 ...
 {signatureData && (
 <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="bg-[#040711] p-3 rounded-xl border border-theme-border mt-2 font-mono text-[10px] text-[#cad8f8]">
 ...
 <div className="text-theme-accent text-[9px] mt-1">EIP-712 Standard structure securely verified off-chain.</div>
 </motion.div>
 )}
 </div>
 ...
 {/* Stage 3 */}
 <div className="relative pl-6">
 <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border-2 ${currentStage === 3 ? 'bg-cyan-400 border-theme-border animate-pulse' : currentStage > 3 ? 'bg-[#14bd96] border-[#14bd96]' : 'bg-theme-surface border-theme-border'}`} />
 <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
 <div>
 <h4 className={`text-xs font-bold ${currentStage === 3 ? 'text-theme-accent' : 'text-white'}`}>Stage 3: Verification & Relaying</h4>
 ...
 {verificationData && (
 <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="bg-[#040711] p-3 rounded-xl border border-theme-border mt-2 font-mono text-[10px] text-[#14bd96]">
 ...
 <div className="text-theme-accent truncate">SLA Tx Hash: {verificationData.gas_subsidized_tx}</div>
 </motion.div>
 )}
 </div>
 ...
 {/* Stage 4 */}
 <div className="relative pl-6">
 <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border-2 ${currentStage === 4 ? 'bg-cyan-400 border-theme-border animate-pulse' : currentStage > 4 ? 'bg-[#14bd96] border-[#14bd96]' : 'bg-theme-surface border-theme-border'}`} />
 <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
 <div>
 <h4 className={`text-xs font-bold ${currentStage === 4 ? 'text-theme-accent' : 'text-white'}`}>Stage 4: Workload Execution (Real Gemini API)</h4>
 ...
 {executionResult && (
 <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="bg-[#040711] p-3.5 rounded-xl border border-theme-border mt-2 font-sans space-y-2">
 <span className="text-[#526a9b] block uppercase text-[8px] font-bold font-mono">Response Payload ({getPromptLabel()})</span>
 <div className="text-xs text-white bg-theme-surface p-3 rounded-lg border border-theme-border whitespace-pre-wrap max-h-[120px] overflow-y-auto leading-relaxed italic">"{executionResult.output}"
 </div>
 ...
 {/* Stage 5 */}
 <div className="relative pl-6">
 <div className={`absolute -left-1.5 top-1.5 w-3 h-3 rounded-full border-2 ${currentStage === 5 ? 'bg-cyan-400 border-theme-border animate-pulse' : 'bg-theme-surface border-theme-border'}`} />
 <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
 <div>
 <h4 className={`text-xs font-bold ${currentStage === 5 ? 'text-theme-accent' : 'text-white'}`}>Stage 5: Settlement Override (set_settlement_overrides)</h4>
 ...
 {settlementResult && (
 <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="bg-[#040711] p-3.5 rounded-xl border border-theme-border mt-2 font-mono text-[10px] text-[#14bd96] space-y-1.5">
 ...
 <div className="text-theme-accent font-bold truncate">Project Genome Ledger block: {settlementResult.pgl_block_hash}</div>
 ...
 <div className="bg-[#040711] border border-theme-border rounded-2xl p-5 shadow-xl relative overflow-hidden">
 <div className="absolute top-0 right-0 p-3 text-[9px] font-mono text-theme-accent/40 select-none uppercase tracking-wider">
 CAPPO Live Monitor
 </div>
 ...
 <div className="bg-theme-surface p-4 rounded-xl border border-theme-border font-mono text-[10px] text-[#a4b8e6] h-[220px] overflow-y-auto space-y-1.5 leading-relaxed">
 ...
 log.includes('[HTTP 402]') ? 'text-theme-accent/70 font-bold' : 'text-[#a4b8e6]'
 }>
 {log}
 </div>
 ))}
