...
export default function EvidenceViewer() {
 ...
 className="flex items-center gap-2 px-4 py-2 bg-theme-accent text-white rounded-lg hover:bg-theme-accent/80 disabled:opacity-50 transition-colors"
 >
 <Shield className="w-4 h-4" />
 ...
 className="flex items-center gap-1 px-3 py-1 bg-theme-accent text-white rounded hover:bg-theme-accent/80 disabled:opacity-50 transition-colors text-sm"
 >
