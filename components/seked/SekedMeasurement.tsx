...
export default function SekedMeasurement() {
 ...
 className="flex items-center gap-3 px-8 py-3 bg-theme-accent text-white rounded-lg hover:bg-theme-accent/80 disabled:opacity-50 transition-colors font-medium"
 >
 ...
 <div className="text-2xl font-bold text-theme-accent">{ratios.sigma}</div>
 ...
 <div className="text-2xl font-bold text-theme-accent">{ratios.si}</div>
 ...
 directive.action_type === 'PREPARE' ? 'bg-theme-accent/20 text-theme-accent' :
