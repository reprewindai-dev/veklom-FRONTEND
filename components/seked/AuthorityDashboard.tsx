...
function StatusBadge({ status }: StatusBadgeProps) {
 ...
 executed:"bg-theme-accent/20 text-theme-accent border-theme-border",
 };
...
export default function AuthorityDashboard() {
 ...
 className="flex items-center gap-1 px-3 py-1 bg-theme-accent text-white rounded hover:bg-theme-accent/80 transition-colors"
 >
