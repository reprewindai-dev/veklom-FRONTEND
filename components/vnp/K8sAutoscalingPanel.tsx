...
export default function K8sAutoscalingPanel() {
 ...
 return {
 bg:"bg-[#0a0f18]/90 text-emerald-400 border-theme-border",
 fanSpeed:"1s",
 ...
 <div className="lg:col-span-4 bg-[#0b1017] border border-theme-border rounded-2xl p-5 space-y-5 flex flex-col justify-between">
 ...
 <div className="space-y-3 pt-2 bg-theme-surface p-4 border border-theme-border rounded-xl">
 ...
 className="w-full h-1.5 bg-theme-surface rounded-lg appearance-none cursor-pointer accent-emerald-500"
 />
 ...
 <div className="bg-[#070a10] p-4 border border-theme-border rounded-xl space-y-4 font-mono text-[11px]">
 <div className="flex items-center gap-2 text-xs border-b border-theme-border pb-2.5 text-slate-300 font-bold">
 ...
 <div className="flex justify-between text-[9.5px] text-slate-500 border-t border-theme-border pt-2.5">
 ...
 <div className="lg:col-span-8 border border-theme-border bg-theme-surface rounded-2xl p-5 flex flex-col justify-between">
 ...
 <span className="text-[8.5px] bg-[#111927] border border-theme-border text-slate-400 font-bold font-mono px-2.5 py-0.5 rounded">
 Zone: US-EAST-1A
 </span>
 ...
 :"bg-[#0e1420]/50 border-theme-border hover:border-theme-border text-slate-400"
 }`}
 >
 ...
 {isFirstPod && (
 <span className="text-[7.5px] bg-[#111c2a] border border-theme-border text-slate-400 rounded px-1 uppercase font-bold font-mono">
 MASTER
 </span>
 )}
 </div>
 ...
 <span className="w-1.5 h-1.5 rounded-full bg-theme-info animate-pulse" title="Network strobe LED" />
 </div>
 </div>
 ...
 <div className="mt-4 bg-[#0d131f]/50 p-4 border border-theme-border rounded-xl space-y-2 font-mono text-[9.5px] text-slate-400 animate-fade-in">
 <div className="flex items-center justify-between border-b border-theme-border pb-1.5 mb-1">
 ...
 <div>K8s Readiness Probe: <strong className="text-emerald-400">âœ“ PASS (http-get :9918/health)</strong></div>
 </div>
 </div>
 )}

 {/* Microservice specification block */}
 <div className="mt-4 bg-[#0d121b] border border-theme-border p-3.5 rounded-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs leading-none">
 <div className="space-y-1">
 ...
 <span className="bg-theme-surface border border-theme-border text-slate-400 px-3 py-2 rounded text-center">
 Target: 75% CPU
 </span>
 <span className="bg-theme-surface border border-theme-border text-slate-400 px-3 py-2 rounded text-center">
 Cooldown: 60s
