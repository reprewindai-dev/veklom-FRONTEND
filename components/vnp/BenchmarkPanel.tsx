...
export default function BenchmarkPanel({ apis, trustBeacon, blockAnchored, onRefreshTelemetry }: BenchmarkPanelProps) {
 ...
 if (p99 < 700) return"text-theme-accent bg-theme-surface2 border-theme-border";
 ...
 const rows: Record<string, { value: string; bar: number }> = {"Physical measurements": {
 ...
 <div className="bg-[#0b1017] border border-theme-border rounded-2xl p-5 space-y-5">
 <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-theme-border pb-5">
 ...
 <div key={section.label} title={section.description} className="rounded-xl border border-theme-border bg-theme-surface px-3 py-2">
 ...
 :"bg-theme-surface border-theme-border hover:border-theme-border hover:bg-[#0c1119]/50"
 }`}
 >
 ...
 {/* Card Header */}
 <div className="p-6 border-b border-theme-border flex flex-col md:flex-row md:items-start justify-between gap-4 bg-[#0a0a0a]">
 ...
 {/* Kill Metrics Strip */}
 <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-900/80 bg-[#050505] border-b border-theme-border">
 ...
 <div className="border-b border-theme-border bg-[#080808] p-6">
 ...
 {/* Benchmark Details */}
 <div className="space-y-2">
 <span className="text-slate-300 font-bold uppercase border-b border-theme-border pb-1.5 block tracking-widest">Benchmark Details</span>
 ...
 <div className="space-y-2">
 <span className="text-slate-300 font-bold uppercase border-b border-theme-border pb-1.5 block tracking-widest">Methodology</span>
 <div className="space-y-1.5 text-slate-400">
 <div className="grid grid-cols-[80px_1fr]"><span className="text-slate-600">Methods:</span> <span>Active 5-Region Edge</span></div>
 <div className="grid grid-cols-[80px_1fr]"><span className="text-slate-600">Metrics:</span> <span className="text-theme-accent">{VNP_VERIFICATION_STACK_TITLE}</span></div>
 ...
 {/* Targeted Risks */}
 <div className="space-y-2">
 <span className="text-slate-300 font-bold uppercase border-b border-theme-border pb-1.5 block tracking-widest">Targeted Risks</span>
 <div className="space-y-1.5 text-slate-400">
 ...
 {/* Ethical & Legal */}
 <div className="space-y-2">
 <span className="text-slate-300 font-bold uppercase border-b border-theme-border pb-1.5 block tracking-widest">Compliance</span>
 <div className="space-y-1.5 text-slate-400">
 ...
 <div className="flex items-center gap-3">
 <div className="w-16 h-1 bg-theme-surface rounded-full overflow-hidden">
 ...
 <thead>
 <tr className="text-slate-500 border-b border-theme-border pb-2">
 ...
 {/* Integrity Footer */}
 <div className="bg-[#020202] border-t border-theme-border p-3 px-6 flex flex-wrap items-center justify-between gap-4 font-mono text-[9px] text-slate-500 uppercase tracking-widest font-bold">
 ...
 <div className="border border-theme-border bg-[#0d121b] rounded-2xl p-5 space-y-4">
 ...
 if (!m) return null;
 const p99Color = m.p99 < 350 ?"text-emerald-400" : m.p99 < 800 ?"text-theme-accent" :"text-amber-400";

 return (
 <div key={reg} className="p-3 bg-theme-surface border border-theme-border rounded-xl space-y-2 hover:border-theme-border transition">
 <span className="text-[9px] font-bold font-mono tracking-widest uppercase text-slate-500 block text-center border-b border-theme-border pb-1.5">
 {reg.toUpperCase()}
 </span>
 ...
 <div className="text-[9px] font-mono whitespace-nowrap text-slate-400 space-y-1 border-t border-theme-border pt-1.5">
 ...
 <div className="lg:col-span-5 bg-[#080d14]/90 border border-theme-border rounded-2xl p-5 space-y-5 flex flex-col justify-between">
 ...
 className="w-full bg-theme-surface border border-theme-border rounded-xl p-2.5 text-slate-200 focus:outline-none focus:border-emerald-500 font-mono"
 required
 />
 </div>
 ...
 className="rounded border-theme-border bg-theme-surface text-emerald-500 focus:ring-opacity-0 w-3.5 h-3.5"
 />
 ...
 <div className="lg:col-span-7 bg-[#080d14]/90 border border-theme-border rounded-2xl p-5 space-y-4 flex flex-col justify-between">
 <div className="space-y-1.5">
 <div className="flex items-center justify-between">
 <span className="text-[10px] text-theme-accent font-mono uppercase tracking-widest flex items-center gap-1.5 font-bold">
 <Layers className="w-4 h-4 text-theme-accent" /> VNP LIVE GATEWAY SANDBOX
 </span>
 <span className="text-[8.5px] uppercase font-bold tracking-wider bg-theme-surface2 border border-theme-border text-theme-accent/70 px-2 py-0.5 rounded animate-pulse">
 ...
 className="w-full bg-theme-surface border border-theme-border rounded-xl p-2.5 text-slate-200 focus:outline-none"
 >
 ...
 <div className="p-2.5 bg-theme-surface border border-theme-border rounded-xl text-slate-300 font-bold flex items-center justify-between">
 ...
 rows={2}
 className="w-full bg-theme-surface border border-theme-border rounded-xl p-2.5 text-slate-200 focus:outline-none focus:border-emerald-500 font-mono text-[10px]"
 placeholder="{}"
 />
 </div>
 ...
 method:"POST",
 headers: {"Content-Type":"application/json","x-vnp-tenant": proxyTenant
 },
 ...
 disabled={isProxying}
 className="w-full py-3 bg-theme-accent hover:bg-theme-accent disabled:opacity-50 text-white rounded-xl font-bold cursor-pointer transition flex items-center justify-center gap-1.5 uppercase font-mono tracking-wider"
 >
 <Zap className="w-4 h-4 text-theme-accent/70 animate-pulse" />
 ...
 {proxyResult && (
 <div className="space-y-2 bg-[#05060b] rounded-xl border border-theme-border p-3">
 ...
 <div className="grid grid-cols-3 gap-2.5 text-[9px] border-b border-theme-border pb-2">
 <div className="bg-theme-surface rounded p-1.5 border border-theme-border text-center">
 <span className="text-slate-600 uppercase block font-bold leading-tight">Tx Hash Id</span>
 <span className="text-theme-accent block truncate uppercase font-bold mt-0.5">{proxyResult.vnpTransactionId.split("_").pop()}</span>
 </div>
 <div className="bg-theme-surface rounded p-1.5 border border-theme-border text-center">
 ...
 <span className="text-theme-accent block font-bold mt-0.5 font-mono">HTTP {proxyResult.downstreamHttpStatus}</span>
 </div>
 </div>

 <div className="space-y-1">
 <span className="text-[9.5px] text-slate-500 font-bold block uppercase pb-0.5">Downstream Payload Output:</span>
 <pre className="p-2.5 bg-theme-surface rounded border border-theme-border font-mono text-[9.5px]/normal text-[#a7f3d0] max-h-[110px] overflow-y-auto overflow-x-hidden custom-scrollbar">
