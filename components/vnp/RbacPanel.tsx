...
export default function RbacPanel({ auditLogs, onExportReport, exporting }: RbacPanelProps) {
 ...
 isSelected
 ?"bg-theme-surface border-emerald-500/50 text-emerald-300"
 :"bg-theme-surface border-transparent hover:bg-theme-surface text-slate-400 hover:text-white"
 }`}
 >
 <div>
 ...
 :"bg-theme-surface text-slate-400 border border-theme-border"
 }`}>
 {tenant.role}
 </span>
 </button>
 ...
 className="w-full bg-[#0a0d13] border border-theme-border rounded px-2.5 py-1.5 text-xs text-slate-100 placeholder:text-slate-600 focus:outline-none focus:border-emerald-500"
 />
 </div>
 ...
 className="w-full bg-[#0a0d13] border border-theme-border rounded p-1.5 text-xs text-slate-200 focus:outline-none focus:border-emerald-500"
 >
 ...
 <div className="bg-theme-surface border border-theme-border rounded-xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
 ...
 <div className="font-mono text-[9px] text-slate-500 bg-theme-surface border border-theme-border px-3 py-1.5 rounded space-y-0.5">
 ...
 <div className="border border-theme-border bg-[#0d1117] rounded-xl p-5 flex flex-col justify-between min-h-[380px]">
 ...
 <span className="text-[9px] bg-[#0c121e] px-2.5 py-0.5 text-slate-500 rounded font-mono font-bold border border-theme-border">
 Lineage View
 </span>
 </div>
 ...
 <div className="p-8 text-center text-slate-600 space-y-2 border border-dashed border-theme-border rounded-lg">
 ...
 <div key={index} className="p-3 bg-theme-surface border border-theme-border rounded-lg space-y-1.5 hover:border-theme-border transition duration-150">
 ...
 <span className="bg-theme-surface border border-theme-border text-[9px] text-slate-400 px-1.5 py-0.5 rounded truncate max-w-[140px]">
 {log.actor}
 </span>
 </div>
 <div className="text-[10px] text-slate-500 flex justify-between pt-0.5 border-t border-theme-border">
 ...
 <div className="border-t border-theme-border pt-4 mt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 text-xs">
 ...
 className="px-3 py-1.5 bg-theme-accent hover:bg-theme-accent disabled:opacity-40 text-white rounded text-[11px] font-bold transition flex items-center gap-1 cursor-pointer"
 >
 ...
 disabled={exporting || activeTenant.role === UserRole.VISITOR_DEV}
 className="px-3 py-1.5 bg-theme-surface hover:bg-theme-surface disabled:opacity-40 text-slate-300 hover:text-white rounded text-[11px] font-bold border border-theme-border transition cursor-pointer"
 >
 ...
 <div className="bg-theme-surface p-4.5 rounded-xl border border-theme-border font-mono space-y-3.5">
 <div className="flex items-center gap-1.5 text-xs text-slate-300 font-bold border-b border-theme-border pb-2.5">
 ...
 <div className="p-2.5 bg-theme-surface border border-theme-border rounded-lg flex flex-col justify-between">
 ...
 <div className="p-2.5 bg-[#070b12] border border-theme-border rounded-lg flex flex-col justify-between">
