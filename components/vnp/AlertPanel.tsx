...
export default function AlertPanel({ configs, logs, onAddConfig, onRefresh, loading }: AlertPanelProps) {
 ...
 <div className="lg:col-span-2 bg-theme-surface border border-theme-border rounded-xl p-5 space-y-5">
 <div className="flex items-center justify-between">
 <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400 flex items-center gap-2">
 <Settings className="w-4.5 h-4.5 text-emerald-400" /> SEKED Policy Engine
 </h3>
 <span className="text-[10px] uppercase font-mono bg-theme-surface text-slate-400 px-2 py-0.5 rounded">Real-Time</span>
 </div>
 ...
 className="w-full bg-theme-surface border border-theme-border rounded p-2.5 text-slate-200 focus:outline-none focus:border-emerald-500"
 >
 ...
 className="w-full bg-theme-surface border border-theme-border rounded p-2.5 text-slate-200 focus:outline-none focus:border-emerald-500 font-mono"
 ...
 className="w-full bg-theme-surface border border-theme-border rounded p-2.5 text-slate-200 focus:outline-none"
 ...
 className="w-full bg-theme-surface border border-theme-border rounded p-2.5 text-slate-200 focus:outline-none font-mono"
 ...
 {configs.map((cfg) => (
 <div key={cfg.id} className="bg-theme-surface p-2.5 rounded border border-theme-border space-y-1 flex justify-between items-center text-[10px] font-mono">
 ...
 <div className="lg:col-span-3 border border-theme-border bg-[#0d1117] rounded-xl p-5 flex flex-col justify-between">
 ...
 onClick={onRefresh}
 disabled={loading}
 className="p-1.5 bg-theme-surface hover:bg-theme-surface border border-theme-border rounded text-[11px] text-slate-300 flex items-center gap-1 transition"
 >
 ...
 {logs.length === 0 ? (
 <div className="p-8 text-center bg-theme-surface border border-dashed border-theme-border rounded-lg text-slate-500 space-y-2">
 ...
 <div className="pt-4 border-t border-theme-border text-[10px] text-slate-500 font-mono text-center">
