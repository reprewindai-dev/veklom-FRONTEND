...
function StakesComingSoon({ reason }: { reason?: string }) {
 ...
 {["Provider bond amounts and SLA tiers","Real-time latency vs. 800ms threshold","Epoch settlement payouts and slash history","KDE consensus rate across verifier nodes","Micro-stake yield per 1,000 requests",
 ].map((item) => (
