...
export default function QuarantineDashboard() {
 ...
 <div className="text-[10px] font-mono bg-theme-surface px-2 py-1 rounded text-slate-400 border border-theme-border">
 ...
 {intents.length === 0 ? (
 <div className="p-8 text-center text-slate-500 text-[11px] font-mono border border-theme-border rounded-lg bg-theme-surface flex flex-col items-center gap-2">
 ...
 <pre className="text-[10px] text-slate-300 font-mono overflow-x-auto custom-scrollbar p-3 bg-black/60 rounded border border-theme-border">
 {JSON.stringify(intent.payload, null, 2)}
 </pre>
 </div>

 <div className="p-3 border-t border-[#8B5CF6]/10 bg-theme-surface flex gap-3">
 <button 
