...
export default function AiAdvisorPanel() {
 ...
 const predefinedPrompts = ["Explain standard VNP weighting model","How does x402 payment schema align with benchmarks?","What triggers Kubernetes HPA inside distributed clusters?"
 ];
 ...
 {/* Prompt helpers */}
 <div className="lg:col-span-1 bg-theme-surface backdrop-blur border border-theme-border rounded-xl p-5 flex flex-col justify-between">
 ...
 className="w-full text-left p-2.5 rounded-lg text-[10px] bg-theme-surface border border-theme-border hover:border-emerald-500/45 hover:bg-theme-surface hover:text-emerald-300 text-slate-300 transition duration-150"
 >
 {p}
 </button>
 ))}
 ...
 <div className="bg-theme-surface p-3 rounded-lg border border-theme-border flex items-center gap-2 text-[10px] text-slate-400 mt-4">
 ...
 {/* Actual chat screen */}
 <div className="lg:col-span-3 border border-theme-border bg-theme-surface backdrop-blur rounded-xl overflow-hidden flex flex-col h-full">
 {/* Chat Header */}
 <div className="bg-theme-surface border-b border-theme-border px-5 py-3 flex items-center justify-between">
 <div className="flex items-center gap-2">
 <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping" />
 <span className="text-xs font-semibold text-slate-200">Consensus Leaderboard AI Assessor</span>
 <span className="text-[9px] bg-theme-surface text-slate-400 px-2 py-0.5 rounded uppercase font-mono tracking-widest">Active</span>
 </div>

 <button
 onClick={handleClear}
 className="p-1 px-2.5 text-slate-400 hover:text-red-400 bg-theme-surface hover:bg-red-500/10 border border-theme-border hover:border-red-500/20 rounded text-[11px] flex items-center gap-1 transition"
 >
 ...
 {/* Profile icon */}
 <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${m.sender ==="user" ?"bg-emerald-500/10 border border-emerald-500/30 text-emerald-300" :"bg-theme-accent/10 border border-theme-border text-theme-accent/70"}`}>
 ...
 :"bg-theme-surface border border-theme-border text-slate-100 rounded-tl-none"
 }`}>
 {m.text}
 {m.isSimulated && (
 ...
 <div className="w-8 h-8 rounded-full bg-theme-accent/10 border border-theme-border text-theme-accent/70 flex items-center justify-center flex-shrink-0">
 <Bot className="w-4.5 h-4.5" />
 </div>
 <div className="space-y-1">
 <div className="p-4 bg-theme-surface border border-theme-border text-slate-400 rounded-2xl rounded-tl-none flex items-center gap-2">
 ...
 className="border-t border-theme-border p-3 bg-theme-surface flex items-center gap-2"
 >
 <input
 type="text"
 value={input}
 ...
 className="flex-1 bg-theme-surface border border-theme-border hover:border-theme-border focus:border-emerald-500 focus:outline-none p-2.5 rounded-lg text-slate-200 text-xs transition duration-150"
 />
 <button
 type="submit"
