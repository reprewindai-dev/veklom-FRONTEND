...
export const EvidenceLedger: React.FC<EvidenceLedgerProps> = ({
 ...
 const headers = ["Sequence No","Timestamp","Event Type","Log Level","Target Path","Policy Result","Message"
 ];
 ...
 className="w-full flex items-center justify-center space-x-2 py-2 px-4 bg-theme-surface from-emerald-600 via-teal-500 hover:opacity-90 disabled:opacity-30 text-black font-extrabold text-[10px] uppercase tracking-widest rounded-xs transition-all border border-teal-500/30 select-none cursor-pointer disabled:cursor-not-allowed shadow-[0_0_12px_rgba(20,184,166,0.15)]"
 ...
 disabled={events.length === 0}
 className="w-full flex items-center justify-center space-x-2 py-2 px-4 bg-theme-surface hover:opacity-90 disabled:opacity-30 text-black font-extrabold text-[10px] uppercase tracking-widest rounded-xs transition-all border border-theme-border select-none cursor-pointer disabled:cursor-not-allowed shadow-[0_0_12px_rgba(37,99,235,0.15)]"
 ...
 disabled={events.length === 0}
 className="w-full flex items-center justify-center space-x-2 py-2 px-4 bg-theme-surface from-orange-600 via-[#FF6B00] to-amber-500 hover:opacity-90 disabled:opacity-30 text-black font-extrabold text-[10px] uppercase tracking-widest rounded-xs transition-all border border-[#FF6B00]/30 select-none cursor-pointer disabled:cursor-not-allowed shadow-[0_0_12px_rgba(255,107,0,0.15)]"
