...
const CONDITION_VAR: Record<ActivityCondition, string> = {
  unknown: "var(--vac-unknown, var(--unknown, #6B7280))",
  active: "var(--vac-active, var(--info, #00E5FF))",
  present: "var(--vac-present, var(--present, var(--accent-steel, var(--mid-gray, #8A9BB0))))",
  verified: "var(--vac-verified, var(--verified, #00FF66))",
  degraded: "var(--vac-degraded, var(--warn, #FFAB00))",
  failed: "var(--vac-failed, var(--danger, #FF4D4D))",
};

const STEEL_VAR = "var(--vac-steel, var(--accent-steel, var(--mid-gray, #8A9BB0)))";
...
export function VeklomActivityCue({
  ...
  return (
    <div className={rootClass} style={{ display: "inline-flex", alignItems: "center", gap: 10, ...style }}>
      ...
      {showCaption && (
        <div className="vac-caption" style={{ color: "var(--text, currentColor)" }}>
