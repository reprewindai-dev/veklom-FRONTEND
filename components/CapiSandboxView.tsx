...
export const CapiSandboxView: React.FC<CapiSandboxViewProps> = ({
 ...
 <div className="bg-theme-surface p-5 rounded-2xl border border-theme-border space-y-5">
 <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider font-mono flex items-center gap-2">
 <Layers className="w-4 h-4 text-theme-accent" /> 1. Select Harness & Skill
 </h3>
 ...
 isSelected
 ? 'bg-theme-accent/15 border-theme-border text-white shadow'
 : 'bg-theme-surface border-theme-border text-slate-400 hover:bg-theme-surface hover:text-slate-200'
 }`}
 >
 <div className="flex items-center justify-between text-2xs font-mono">
 <span className="font-bold flex items-center gap-1.5">
 <Icon className={`w-3.5 h-3.5 ${isSelected ? 'text-theme-accent' : 'text-slate-500'}`} />
 {h.name}
 </span>
 </div>
 ...
 <div className="p-3.5 bg-theme-surface rounded-xl border border-theme-border space-y-3 font-mono text-xs">
 <div className="flex items-center justify-between">
 <span className="text-theme-accent font-bold flex items-center gap-1.5 text-2xs">
 ...
 className="w-full bg-theme-surface border border-theme-border rounded px-2.5 py-1.5 text-2xs text-slate-200 focus:outline-none focus:border-theme-border"
 />
 </div>
 ...
 className="w-full bg-theme-surface border border-theme-border rounded-xl px-3 py-2 text-xs font-mono text-slate-200 focus:outline-none focus:border-theme-border"
 >
 {skills.map((s) => (
 ...
 <span className="text-theme-accent text-3xs">veklom-skill-spec Schema</span>
 </div>
 <textarea
 rows={5}
 value={paramInput}
 onChange={(e) => setParamInput(e.target.value)}
 className="w-full bg-theme-surface border border-theme-border rounded-xl p-3 font-mono text-2xs text-slate-200 focus:outline-none focus:border-theme-border leading-relaxed"
 ></textarea>
 </div>
 ...
 className="w-full bg-theme-surface border border-theme-border rounded-xl px-3 py-2 text-2xs font-mono text-slate-200 focus:outline-none focus:border-theme-border"
 />
 </div>

 {/* Quebec Law 25 & PII Sovereignty Enforcer Control */}
 <div className="p-3.5 bg-theme-surface rounded-xl border border-theme-border space-y-2">
 <div className="flex items-center justify-between">
 <label className="text-2xs font-mono font-bold text-theme-accent/70 flex items-center gap-1.5 cursor-pointer">
 <input
 type="checkbox"
 checked={containsPii}
 onChange={(e) => setContainsPii(e.target.checked)}
 className="rounded border-theme-border bg-theme-surface text-theme-accent focus:ring-theme-accent h-3.5 w-3.5"
 />
 <ShieldAlert className="w-3.5 h-3.5 text-theme-accent" /> Quebec Law 25 / PII Sovereignty Enforcer
 </label>
 <span className={`text-3xs px-2 py-0.5 rounded font-mono ${containsPii ? 'bg-theme-accent/20 text-theme-accent/70 border border-theme-border' : 'bg-theme-surface text-slate-500'}`}>
 ...
 <div className="p-3.5 bg-theme-surface rounded-xl border border-emerald-500/30 space-y-3 font-mono">
 ...
 {x402LeaseToken ? (
 <div className="p-2.5 bg-theme-surface rounded border border-emerald-500/20 text-3xs space-y-1.5">
 ...
 <div className="pt-1 border-t border-theme-border text-3xs space-y-0.5">
 ...
 <span className="px-2.5 py-0.5 rounded bg-theme-accent/10 text-theme-accent text-3xs font-mono font-bold border border-theme-border">
 ...
 <div className="p-2 bg-theme-surface rounded-lg border border-theme-border">
 <div className="text-slate-400 text-3xs">EI Token</div>
 <div className="text-theme-accent font-bold truncate mt-0.5">{invocationResult.eiToken}</div>
 </div>
 <div className="p-2 bg-theme-surface rounded-lg border border-theme-border">
 ...
 <div className="text-theme-accent font-bold mt-0.5">
 ...
 <div className="text-theme-accent/70 font-bold mt-0.5">{invocationResult.vnpMetrics.throughputTps} TPS</div>
 </div>
 <div className="p-2 bg-theme-surface rounded-lg border border-theme-border">
 ...
 <div className="p-3 bg-theme-surface rounded-xl border border-theme-border font-mono text-3xs text-slate-300 space-y-1 max-h-36 overflow-y-auto">
 ...
 <pre className="p-3 bg-theme-surface rounded-xl border border-theme-border font-mono text-3xs text-theme-accent/70 whitespace-pre-wrap overflow-x-auto">
 ...
 <pre className="p-4 bg-theme-surface rounded-xl border border-theme-border font-mono text-2xs text-emerald-300 whitespace-pre-wrap overflow-x-auto">
 ...
 <div className="bg-theme-surface p-5 rounded-2xl border border-theme-border space-y-3 font-mono text-xs">
 ...
 <div className="p-3 bg-theme-surface rounded-xl border border-theme-border space-y-2 text-2xs">
 ...
 <div><span className="text-slate-400">Merkle Root:</span> <span className="text-theme-accent">{invocationResult.pglCertificate.merkleRoot}</span></div>
 ...
 <div><span className="text-slate-400">Verifier Signature:</span> <span className="text-theme-accent">{invocationResult.pglCertificate.verifierSignature}</span></div>
 </div>
 </div>
 </div>
 ) : (
