...
const styles: Record<ProofStatus, string> = {
 ...
 Live:"border-cos-info/30 bg-cos-info/10 text-cos-info","Needs proof":"border-cos-unknown/30 bg-cos-unknown/10 text-cos-unknown",
 Degraded:"border-cos-warn/30 bg-cos-warn/10 text-cos-warn","Not started":"border-cos-unknown/30 bg-cos-unknown/10 text-cos-unknown","Manual step":"border-cos-warn/30 bg-cos-warn/10 text-cos-warn",
