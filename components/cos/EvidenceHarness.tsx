...
export function EvidenceHarness() {
  ...
  async function retrieve() {
    ...
    try {
      const next = await fetchExecutionEvidence(executionId) as EvidenceRecord;
      setRecord(next.execution_id === executionId ? next : {
        ...next,
        proof_state: 'failed',
